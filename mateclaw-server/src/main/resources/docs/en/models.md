...
When does it fire? `MultimodalRouter` ([source](https://github.com/LittleSongxx/NewsClaw/blob/main/mateclaw-server/src/main/java/vip/mate/llm/routing/MultimodalRouter.java)) decides per turn:
