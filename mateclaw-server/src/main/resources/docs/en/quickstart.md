...
- JWT_SECRET
- MATECLAW_SETTING_KEY and MATECLAW_ENCRYPT_KEY
- SEARXNG_SECRET
...
docker-compose.yml retains mateclaw as its Compose project name to preserve
...
- No model output: check provider keys, model catalog rows, and docker compose logs -f mateclaw-server.
