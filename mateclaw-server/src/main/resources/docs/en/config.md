...
| MATECLAW_SETTING_KEY | AES-GCM key for sensitive system settings |
| MATECLAW_ENCRYPT_KEY | Encryption key for Skill secrets and datasource passwords |
...
~~~dotenv
MATECLAW_ENV_CONFIG_ENABLED=true
...
~~~dotenv
MATECLAW_SEARCH_ENABLED=true
MATECLAW_SEARCH_FALLBACK_ENABLED=true
MATECLAW_SEARCH_PROVIDER=serper
SERPER_API_KEY=
TAVILY_API_KEY=
SEARXNG_BASE_URL=http://searxng:8080

MATECLAW_AI_NEWS_OFFICIAL_CAPTURE_ENABLED=true
MATECLAW_AI_NEWS_OFFICIAL_CAPTURE_MAX_BYTES=524288
MATECLAW_AI_NEWS_OFFICIAL_CAPTURE_TIMEOUT_SECONDS=15
MATECLAW_AI_NEWS_OFFICIAL_CAPTURE_MAX_REDIRECTS=5
~~~
...
MATECLAW_AI_NEWS_RADAR_ENABLED=true
~~~
...
~~~dotenv
MATECLAW_MEMORY_GOVERNANCE_ENABLED=true
MATECLAW_MEMORY_WRITE_MAX_TOKENS=320
MATECLAW_MEMORY_LONG_TERM_TOKEN_BUDGET=2400
MATECLAW_MEMORY_REJECT_NEWS_BODY=true
MATECLAW_MEMORY_REQUIRE_SOURCE_REF=true

MATECLAW_SKILL_REFLECTION_ENABLED=false
MATECLAW_SKILL_REFLECTION_AUTO_APPLY=false
MATECLAW_SKILL_ROUTINE_ENABLED=false
MATECLAW_SKILL_ROUTINE_AUTO_PROMOTE=false
~~~
...
For diagnosis, start with docker compose logs -f mateclaw-server and the health
endpoint.
