...
- JWT_SECRET
- MATECLAW_SETTING_KEY、MATECLAW_ENCRYPT_KEY
- SEARXNG_SECRET
...
docker-compose.yml 的 Compose 项目名为 mateclaw，以保持已验证的容器、网络与
...
- 模型没有输出：检查 Provider Key、模型目录行及 docker compose logs -f mateclaw-server。
