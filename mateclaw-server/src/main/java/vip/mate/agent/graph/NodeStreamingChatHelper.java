...
public class NodeStreamingChatHelper {
    ...
    private vip.mate.llm.trace.LlmRoutingTraceService routingTraceService;
     ...
     */
    public void setRoutingTraceContext(vip.mate.llm.trace.LlmRoutingTraceService traceService,
    ...
    private void traceRouting(String role, String providerId, String modelName,
        ...
        routingTraceService.record(new vip.mate.llm.trace.LlmRoutingTraceService.RoutingTrace(
