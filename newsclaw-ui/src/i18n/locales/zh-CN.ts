export default {
  app: {
    title: 'NewsClaw - AI 动态内容运营 Agent',
  },
  router: {
  ...
  teamRuns: {
    ...
    duration: { day: '天', hour: '小时', minute: '分', second: '秒' },
    ...
    taskProgress: '任务进度',
    stopReason: '停止原因',
    workerReadOnly: '执行任务会话',
    workerReadOnlyDescription: '此委派任务会话为只读。',
    backToLead: '返回主会话',
    openInTeams: '团队',
    openInAgents: 'Agent',
  },
  ...
  settings: {
    ...
    aboutTitle: '关于 NewsClaw',
    aboutDesc: 'AI 动态内容运营系统的版本与技术信息',
    about: {
      heroDesc: '面向 AI 行业动态的发现、核验、内容生产与运营反馈闭环。',
      foundationTitle: '技术栈',
      pillars: {
    ...
    model: {
      ...
      addProviderDrawerTitle: '启用/恢复提供商',
      addProviderDrawerSubtitle: '禁用后的提供商可在这里恢复；启用后会出现在模型下拉中。云端提供商可能还需要填 API Key。',
      catalogEmpty: '目录为空',
      ...
      claudeCodeOauthRevokeHint: '请在 Claude Code 客户端中退出登录。NewsClaw 不会修改 Claude Code 的本地凭据。',
    ...
    hints: {
      ...
      workspaceStorageRootPlaceholder: '留空使用服务端默认位置，例如 /data/newsclaw/workspace',
      ...
      tavilyApiKey: '支持一次配置多个 Key（每行一个，也可用逗号分隔）；鉴权、限流或额度不足时自动切换。提交非空内容会整体替换现有号池。',
      tavilyApiKeyPlaceholder: '每行粘贴一个 Tavily API Key',
      tavilyApiKeysConfigured: '已配置 {count} 个 Key；粘贴新列表可整体替换',
    ...
    localTools: {
      desktopOnly: '本地工具仅在桌面客户端内可用。请在 NewsClaw 桌面应用中打开此页面进行管理。',
      enableLabel: '启用本地工具',
  ...
  agents: {
    ...
    fields: {
      ...
      runtimeNativeHint: '使用 NewsClaw 原生 Agent Loop。',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: '阿里云 DashScope key — 跟 NewsClaw .env 里的 DASHSCOPE_API_KEY 同一个值',
  ...
  plugins: {
    ...
    noDescription: '暂无描述',
    emptyTitle: '暂无已安装插件',
    emptyHint: '将插件 JAR 文件放入 ~/.newsclaw/plugins/ 目录后重启服务',
    loading: '加载插件中...',
    loadFailed: '加载插件失败',
    enabled: '{name} 已启用',
    disabled: '{name} 已禁用',
  ...
  login: {
    ...
    heroDesc: 'NewsClaw 的重点不是把更多能力堆进聊天框，而是把上下文、知识、执行和记忆收拢成一个可靠的工作面。',
  ...
  channels: {
    ...
    webchatHint: 'Web / API 接入既可嵌入聊天挂件，也可作为 SSE API。首次 POST /api/v1/channels/webchat/stream 只需 X-MC-Key 与 {message}；请保存 meta 事件返回的 visitorId + visitorToken，后续对话需同时回传。',
  ...
  skillCurator: {
    title: '技能管家',
    desc: '观测技能使用、挖掘重复工作，并通过人工审核的变更提案持续运营 Agent 能力。',
    stateEnabled: '已部署',
    stateActivated: '已激活',
    statePreview: '仅预览',
    statePaused: '已暂停',
    ...
    routines: '例行事项挖掘',
    routinesHint: '扫描各会话的首条请求并聚类重复工作。同时满足「出现 {occurrences} 次」和「跨 {days} 天」后可生成待审核 Skill 变更；候选不会直接写入生产技能。',
    noRoutines: '暂无候选',
    routineMine: '立即挖掘',
    routineMineSuccess: '挖掘完成，更新了 {n} 个候选',
    routineFilterObserving: '观察中',
    routineFilterProposed: '待审批',
    routineFilterPromoted: '已应用',
    routineFilterDismissed: '已忽略',
    routineFilterAll: '全部',
    routineStatusObserving: '观察中',
    routineStatusReady: '达标待提案',
    routineStatusProposed: '待审批',
    routineStatusPromoted: '已应用',
    routineStatusDismissed: '已忽略',
    routineOccurrences: '{n} 次',
    routineDays: '跨 {n} 天',
    routineLastSeen: '最近',
    routinePromote: '生成待审核变更',
    routinePromoteEarly: '提前生成变更',
    routinePromoteEarlyConfirm: '该候选目前只出现 {occurrences} 次、跨 {days} 天，尚未达到门槛。继续会消耗一次 LLM 调用来生成待审核 diff，但不会直接写入生产 Skill。确认继续？',
    routinePromoteSuccess: '已生成待审核 Skill 变更',
    routineDismiss: '忽略',
    routineDismissSuccess: '已忽略，后续挖掘不会再重开',
    routineReopen: '重新观察',
    routineReopenSuccess: '已重新纳入观察',
    proposals: 'Skill 变更审核',
    proposalsHint: 'Reflection 和 Routine Mining 只能提交候选。管理员先查看证据与精确 diff，再分两步批准、应用；应用前自动创建还原点，应用后仍可审计回滚。',
    noProposals: '当前筛选下没有变更提案',
    proposalId: '提案',
    proposalView: '查看提案',
    proposalFilterPending: '待审批',
    proposalFilterApproved: '已批准',
    proposalFilterApplied: '已应用',
    proposalFilterBlocked: '安全阻断',
    proposalFilterRejected: '已拒绝',
    proposalSourceRoutine: '来源：Routine Mining',
    proposalSourceReflection: '来源：Reflection',
    proposalSourceOther: '来源：人工或其他',
    proposalSourceRun: '来源候选',
    proposalActionCreate: '动作：新建',
    proposalActionEdit: '动作：更新',
    proposalActionPatch: '动作：局部修改',
    proposalRisk: '风险',
    proposalReviewer: '审核人',
    proposalDiff: '查看精确变更与证据',
    proposalEvidence: '来源证据与安全扫描',
    proposalNoDiff: '无可展示的 diff',
    proposalNoEvidence: '无附加证据',
    proposalReviewNote: '审核说明',
    proposalStatusPending: '待审批',
    proposalStatusBlocked: '安全阻断',
    proposalStatusApproved: '已批准待应用',
    proposalStatusApplying: '应用中',
    proposalStatusRejected: '已拒绝',
    proposalStatusApplied: '已应用',
    proposalStatusRolledBack: '已回滚',
    proposalApprove: '批准',
    proposalReject: '拒绝',
    proposalApply: '应用到生产 Skill',
    proposalRollback: '回滚变更',
    proposalApproveConfirm: '批准「{name}」的当前 diff？批准后仍需单独点击“应用到生产 Skill”。',
    proposalRejectConfirm: '拒绝「{name}」的当前 diff，并记录拒绝原因。',
    proposalApplyConfirm: '将「{name}」应用到生产 Skill。系统会先创建还原点，再执行安全写入和运行时刷新。确认继续？',
    proposalRollbackConfirm: '将「{name}」恢复到应用前的还原点，并保留本次回滚审计。请填写原因。',
    proposalNoteOptional: '审核说明（可选）',
    proposalNoteRequired: '请填写明确原因',
    proposalApproveSuccess: '提案已批准，尚未应用',
    proposalRejectSuccess: '提案已拒绝',
    proposalApplySuccess: '提案已应用并同步候选状态',
    proposalRollbackSuccess: '提案已回滚',
    proposalLoadFailed: '加载 Skill 变更提案失败',
    snapshots: '还原点',
    snapshotsHint: '每次真正执行（非预览）的整理前会自动留一个还原点。整理会归档技能，开启合并去重后还会重写技能正文，且都在无人值守时进行——没有还原点这些改动就是单向的。回滚本身也会先留一个还原点。',
    noSnapshots: '暂无还原点',
    snapshotCapture: '立即捕获',
    snapshotCaptureSuccess: '已捕获还原点',
    snapshotSkillCount: '{n} 个技能',
    snapshotRestore: '回滚到此',
    snapshotRestoreConfirm: '将把所有技能的正文和生命周期状态回滚到 {time} 的状态（共 {n} 个技能），当前内容会被覆盖。回滚前会自动留一个还原点，所以此操作可以再撤销。确认继续？',
    snapshotRestoreSuccess: '已恢复 {restored} 个技能，{missing} 个已不存在而跳过',
    unmanaged: '未纳入治理的技能',
    unmanagedHint: '这些技能不受自动归档管理。移交后由 curator 按闲置时长治理——移交不会重置闲置时钟，已经长期闲置的技能可能在下一轮就被归档。',
    managedList: '已纳管',
    unmanagedList: '未纳管',
    noManaged: '还没有纳入治理的技能',
    release: '撤销移交',
    releaseSuccess: '已撤销「{name}」的移交',
    unobserved: '尚未开始计时',
    noUnmanaged: '没有未纳管的技能',
    unmanagedReasonLegacy: '早于溯源字段，作者不可考',
    unmanagedReasonUser: '用户创建',
    unmanagedDaysIdle: '已闲置 {n} 天',
    adopt: '移交治理',
    adoptConfirm: '确定把「{name}」移交给自治治理？移交不会重置闲置时钟，若它已长期闲置，下一轮扫描可能直接归档。',
    adoptSuccess: '已移交「{name}」',
