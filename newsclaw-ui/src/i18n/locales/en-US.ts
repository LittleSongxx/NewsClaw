export default {
  app: {
    title: 'NewsClaw - AI News Operations Agent',
  },
  router: {
  ...
  settings: {
    ...
    aboutTitle: 'About NewsClaw',
    aboutDesc: 'Version and technical information for the AI news operations system',
    about: {
      heroDesc: 'An evidence-first loop for AI news discovery, verification, content production, and operational feedback.',
    ...
    model: {
      ...
      enableProviderCta: '+ Enable / Restore Provider',
      ...
      addProviderDrawerTitle: 'Enable / Restore Provider',
      addProviderDrawerSubtitle: 'Disabled providers can be restored here. Once enabled, the provider appears in the model dropdown. Cloud providers may still need an API key.',
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. NewsClaw does not modify Claude Code\'s on-disk credentials.',
    ...
    fields: {
      ...
      tavilyApiKey: 'Tavily API Key Pool',
    ...
    hints: {
      ...
      workspaceStorageRootPlaceholder: 'Leave blank for the server default, e.g. /data/newsclaw/workspace',
      ...
      tavilyApiKey: 'Configure multiple keys (one per line or comma-separated). Authentication, rate-limit, and quota failures automatically fail over. A non-empty submission replaces the whole pool.',
      tavilyApiKeyPlaceholder: 'Paste one Tavily API key per line',
      tavilyApiKeysConfigured: '{count} keys configured; paste a new list to replace the pool',
    ...
    localTools: {
      desktopOnly: 'Local tools are only available inside the desktop client. Open this page in the NewsClaw desktop app to manage them.',
  ...
  agents: {
    ...
    fields: {
      ...
      runtimeNativeHint: 'Uses NewsClaw\'s native Agent Loop.',
  ...
  security: {
    ...
    toolGuard: {
      ...
      exportFileName: 'newsclaw-guard-rules-{date}.json',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as NewsClaw .env DASHSCOPE_API_KEY',
  ...
  plugins: {
    ...
    emptyHint: 'Place plugin JAR files in ~/.newsclaw/plugins/ and restart the server',
  ...
  login: {
    ...
    heroDesc: 'NewsClaw is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  channels: {
    ...
    webchatHint: 'Web / API access can embed the NewsClaw chat widget into external websites, or be called as a pure backend SSE API. The first POST to /api/v1/channels/webchat/stream uses X-MC-Key and {message}; save visitorId + visitorToken from the meta event and send both on later turns.',
  ...
  skillCurator: {
    title: 'Skill Curator',
    desc: 'Observe Skill usage, mine repeated work, and operate Agent capabilities through human-reviewed change proposals.',
    ...
    routinesHint: 'Opening requests are clustered across conversations. Once a cluster appears {occurrences} times across {days} days it can produce a reviewable Skill change; candidates never write directly to production Skills.',
    ...
    routineFilterProposed: 'Awaiting review',
    routineFilterPromoted: 'Applied',
    routineFilterDismissed: 'Dismissed',
    routineFilterAll: 'All',
    routineStatusObserving: 'Observing',
    routineStatusReady: 'Ready for proposal',
    routineStatusProposed: 'Awaiting review',
    routineStatusPromoted: 'Applied',
    routineStatusDismissed: 'Dismissed',
    routineOccurrences: '{n}x',
    routineDays: '{n} days',
    routineLastSeen: 'Last seen',
    routinePromote: 'Generate review change',
    routinePromoteEarly: 'Generate early',
    routinePromoteEarlyConfirm: 'This candidate has only appeared {occurrences} times across {days} days, below the threshold. Continuing spends one LLM call to generate a reviewable diff, but does not write a production Skill. Continue?',
    routinePromoteSuccess: 'Reviewable Skill change generated',
    ...
    proposals: 'Skill change review',
    proposalsHint: 'Reflection and Routine Mining can only submit candidates. An administrator reviews evidence and the exact diff, then approves and applies in separate steps. Application captures a restore point and remains auditable and reversible.',
    noProposals: 'No change proposals match this filter',
    proposalId: 'Proposal',
    proposalView: 'View proposal',
    proposalFilterPending: 'Pending',
    proposalFilterApproved: 'Approved',
    proposalFilterApplied: 'Applied',
    proposalFilterBlocked: 'Security blocked',
    proposalFilterRejected: 'Rejected',
    proposalSourceRoutine: 'Source: Routine Mining',
    proposalSourceReflection: 'Source: Reflection',
    proposalSourceOther: 'Source: manual or other',
    proposalSourceRun: 'Source candidate',
    proposalActionCreate: 'Action: create',
    proposalActionEdit: 'Action: edit',
    proposalActionPatch: 'Action: patch',
    proposalRisk: 'Risk',
    proposalReviewer: 'Reviewer',
    proposalDiff: 'View exact change and evidence',
    proposalEvidence: 'Source evidence and security scan',
    proposalNoDiff: 'No diff available',
    proposalNoEvidence: 'No additional evidence',
    proposalReviewNote: 'Review note',
    proposalStatusPending: 'Pending review',
    proposalStatusBlocked: 'Security blocked',
    proposalStatusApproved: 'Approved, awaiting apply',
    proposalStatusApplying: 'Applying',
    proposalStatusRejected: 'Rejected',
    proposalStatusApplied: 'Applied',
    proposalStatusRolledBack: 'Rolled back',
    proposalApprove: 'Approve',
    proposalReject: 'Reject',
    proposalApply: 'Apply to production Skill',
    proposalRollback: 'Roll back change',
    proposalApproveConfirm: 'Approve the current diff for “{name}”? Approval does not apply it; application remains a separate action.',
    proposalRejectConfirm: 'Reject the current diff for “{name}” and record a reason.',
    proposalApplyConfirm: 'Apply “{name}” to the production Skill registry? A restore point is captured before the secured write and runtime refresh.',
    proposalRollbackConfirm: 'Restore “{name}” to its pre-application restore point and retain a rollback audit record. Enter a reason.',
    proposalNoteOptional: 'Review note (optional)',
    proposalNoteRequired: 'Enter a clear reason',
    proposalApproveSuccess: 'Proposal approved; it has not been applied',
    proposalRejectSuccess: 'Proposal rejected',
    proposalApplySuccess: 'Proposal applied and routine state synchronized',
    proposalRollbackSuccess: 'Proposal rolled back',
    proposalLoadFailed: 'Failed to load Skill change proposals',
  ...
  onboarding: {
    title: 'Welcome to NewsClaw',
    subtitle: 'Configure the model chain for AI news operations',
    ...
    send: 'Send',
    startUsing: 'Start Using NewsClaw',
    skip: 'Skip',
    back: 'Back',
  },
  talk: {
  ...
  memory: {
    ...
    memoryBrowser: {
      ...
      scopeShared: 'Shared memory',
      scopePersonal: 'My memory',
      files: {
        memory: 'Memory',
        profile: 'Profile',
        soul: 'Soul',
  ...
  toolLabels: {
    ...
    readNewsClawDoc: 'Read System Docs',
