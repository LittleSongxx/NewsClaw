      ...
      <div class="sidebar-logo">
        ...
        <transition name="fade">
          <div v-if="!effectiveCollapsed" class="logo-text">
            <span class="logo-name">News<span class="logo-name-highlight">Claw</span></span>
    ...
    items: filterNav([
      {
        path: '/ai-news',
        label: 'AI 动态',
        icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16v12H4z"/><path d="m8 20 4-4 4 4"/><path d="M8 8h8M8 11h5"/></svg>`,
...
/*
  ...
  newsclaw token system (`var(--mc-danger-*)`), so dark mode picks up the
