...
// Keep the creation catalog aligned with the AI-news operating loop. Existing
// legacy channel rows remain readable/editable, but new workspaces should be
// offered domestic/local delivery paths only; Discord/Slack/Telegram stay
// backend-compatible without polluting the vertical's primary workflow.
const groups = [
  // Feishu is the default delivery surface for the AI-news vertical.  Keep
  // the other domestic adapters available, but make the primary path obvious
  // on a fresh workspace.
  { key: 'im', types: ['feishu', 'qq', 'weixin', 'dingtalk', 'wecom'] },
