...
onMounted(() => {
  window.addEventListener('newsclaw:workflow-step-select', handleDomStepSelect as EventListener)
...
onBeforeUnmount(() => {
  window.removeEventListener('newsclaw:workflow-step-select', handleDomStepSelect as EventListener)
  document.removeEventListener('keydown', handleEsc)
  document.body.style.overflow = ''
