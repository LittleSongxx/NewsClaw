...
#[tauri::command]
pub(crate) async fn newsclaw_list_providers(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
        run_python_module_json(
            &venv_dir,
            "newsclaw.setup_center.bridge",
            &["list-providers"],
            &[],
        )
    })
...
#[tauri::command]
pub(crate) async fn newsclaw_list_skills(
    venv_dir: String,
    workspace_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_list_models(
    venv_dir: String,
    api_type: String,
    base_url: String,
...
#[tauri::command]
pub(crate) async fn newsclaw_version(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
        ...
        c.args([
            "-c",
            "import newsclaw; print(getattr(newsclaw,'__version__',''))",
        ]);
        let out = c
            .output()
...
#[tauri::command]
pub(crate) async fn newsclaw_health_check_endpoint(
    venv_dir: String,
    workspace_id: String,
    ...
    spawn_blocking_result(move || {
        ...
        run_python_module_json(&venv_dir, "newsclaw.setup_center.bridge", &args, &[])
    })
    .await
}
...
/// Returns JSON array of health results.
#[tauri::command]
pub(crate) async fn newsclaw_health_check_im(
    venv_dir: String,
    workspace_id: String,
...
#[tauri::command]
pub(crate) async fn newsclaw_install_skill(
    venv_dir: String,
    workspace_id: String,
    url: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn newsclaw_uninstall_skill(
    venv_dir: String,
    workspace_id: String,
    skill_name: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn newsclaw_list_marketplace(
    venv_dir: String,
    query: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_get_skill_config(
    venv_dir: String,
    workspace_id: String,
    skill_name: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn newsclaw_wecom_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_wecom_onboard_poll(
    venv_dir: String,
    scode: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_qqbot_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_qqbot_onboard_poll(
    venv_dir: String,
    session_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_qqbot_onboard_create(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_qqbot_onboard_poll_and_create(
    venv_dir: String,
    session_id: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
...
/// Returns JSON with {valid: bool, error?: string}.
#[tauri::command]
pub(crate) async fn newsclaw_qqbot_validate(
    venv_dir: String,
    app_id: String,
    app_secret: String,
) -> Result<String, String> {
...
#[tauri::command]
pub(crate) async fn newsclaw_wechat_onboard_start(venv_dir: String) -> Result<String, String> {
    spawn_blocking_result(move || {
...
#[tauri::command]
pub(crate) async fn newsclaw_wechat_onboard_poll(
    venv_dir: String,
    qrcode: String,
) -> Result<String, String> {
    spawn_blocking_result(move || {
