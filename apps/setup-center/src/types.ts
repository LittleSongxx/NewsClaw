...
export type ViewId = "wizard" | "status" | "chat" | "newsroom" | "wiki" | "skills" | "im" | "onboarding" | "token_stats" | "skill_usage" | "mcp" | "knowledge" | "scheduler" | "memory" | "dashboard" | "agent_manager" | "agent_store" | "skill_store" | "org_editor" | "pixel_office" | "identity" | "docs" | "security" | "pending_approvals" | "plugins" | "my_feedback" | `plugin_app:${string}`;
