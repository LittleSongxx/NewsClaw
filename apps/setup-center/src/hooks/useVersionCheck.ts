...
const GITHUB_REPO = "LittleSongxx/NewsClaw";
const SKIPPED_RELEASE_KEY = "newsclaw_release_skipped";
const LEGACY_DISMISSED_RELEASE_KEY = "newsclaw_release_dismissed";
const REMIND_LATER_RELEASE_KEY = "newsclaw_release_remind_later_session";
