 ...
 *   1) bridge:render-ready  -- plugin called window.OpenNewsClaw.ready() (best;
 ...
 *      for plugins that did NOT call OpenNewsClaw.ready())
...
export default function PluginAppHost({ pluginId, apiBase, onViewChange }: PluginAppHostProps) {
  ...
  const handleIframeLoad = useCallback(() => {
    ...
    // handshake / OpenNewsClaw.ready() will normally fire well within it; if
