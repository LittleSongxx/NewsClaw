...
<style scoped>
.ai-news-page { min-height: 100%; padding: 28px 30px 42px; color: var(--mc-text-primary); }
.page-header { max-width: 1400px; margin: 0 auto 22px; display: flex; align-items: flex-end; justify-content: space-between; gap: 24px; }
.eyebrow { color: var(--mc-primary); font-size: 11px; font-weight: 800; letter-spacing: .14em; margin-bottom: 7px; }
.page-header h1 { margin: 0; font-size: 27px; line-height: 1.2; font-weight: 760; }
.page-header p { margin: 8px 0 0; color: var(--mc-text-tertiary); font-size: 13px; }
.header-actions { display: flex; gap: 10px; flex-shrink: 0; }
.stage-strip, .filter-bar, .event-panel { max-width: 1400px; margin-left: auto; margin-right: auto; }
.stage-strip { display: grid; grid-template-columns: repeat(4, 1fr); background: var(--mc-panel-top); border: 1px solid var(--mc-border); border-radius: 12px; overflow: hidden; margin-bottom: 14px; box-shadow: var(--mc-shadow-soft); }
.stage-item { display: flex; align-items: center; gap: 9px; padding: 15px 18px; border-right: 1px solid var(--mc-border-light); font-size: 13px; color: var(--mc-text-secondary); }
.stage-item:last-child { border-right: 0; }
.stage-item strong { margin-left: auto; color: var(--mc-text-primary); font-size: 18px; }
.stage-dot, .tier-dot { width: 8px; height: 8px; border-radius: 50%; background: #9aa5b1; flex: 0 0 auto; }
.stage-candidate .stage-dot { background: #d9913d; }.stage-verified .stage-dot { background: #3ca274; }.stage-production .stage-dot { background: #667eea; }.stage-published .stage-dot { background: #278b8b; }
.filter-bar { display: flex; gap: 10px; padding: 14px; background: var(--mc-panel-top); border: 1px solid var(--mc-border); border-radius: 10px; box-shadow: var(--mc-shadow-soft); margin-bottom: 16px; }
.keyword-input { max-width: 390px; flex: 1; }.filter-bar .el-select { width: 170px; }.filter-bar .el-button { margin-left: auto; }
.event-panel { background: var(--mc-panel-top); border: 1px solid var(--mc-border); border-radius: 12px; box-shadow: var(--mc-shadow-soft); overflow: hidden; }
...
.event-table { width: 100%; cursor: pointer; }.event-title-cell { padding: 5px 0; }.event-title { font-weight: 650; line-height: 1.35; }.event-summary { color: var(--mc-text-tertiary); font-size: 12px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 500px; margin-top: 4px; }.entity-list { display: flex; gap: 4px; margin-top: 7px; }.entity-list .el-tag { border-radius: 4px; }.evidence-cell { display: grid; grid-template-columns: 9px 1fr; align-items: center; gap: 5px; font-size: 12px; }.evidence-cell small { grid-column: 2; color: var(--mc-text-tertiary); }.tier-dot.official { background: #3ca274; }.tier-dot.media { background: #d9913d; }.tier-dot.community { background: #667eea; }.tier-dot.conflict { background: #d15b5b; }.time-text { color: var(--mc-text-tertiary); font-size: 12px; }.row-chevron { color: var(--mc-text-tertiary); }
