...
class AgentFactory:
    ...
    async def create(
        ...
        **kwargs: Any,
        ...
        from newsclaw.agent.core import Agent, get_primary_agent
        ...
        if profile.permission_rules:
            try:
                from newsclaw.agent.permission import from_config
        ...
        async with create_lock:
            while True:
                ...
                session_entries = [
                    ...
                    and e.profile_generation == self._profile_generations.get(e.profile_id, 0)
                ]
                if session_entries:
