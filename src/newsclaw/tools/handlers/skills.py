...
class SkillsHandler:
    ...
    def _ambiguous_skill_hint(self, key: str) -> str | None:
        from newsclaw.skills.registry import SkillRegistry
    ...
    def _get_skill_info(self, params: dict) -> str:
        ...
        if skill.allowed_tools:
            try:
                from newsclaw.core.policy_v2 import get_skill_allowlist_manager
        ...
        if "{{" in body:
            ...
            from newsclaw.skills.arguments import substitute
        ...
        if skill.arguments:
            from newsclaw.skills.arguments import format_argument_schema
...
修改已生效。"""
    ...
    def _manage_skill_enabled(self, params: dict) -> str:
        """批量启用/禁用外部技能"""
        from newsclaw.skills.allowlist_io import overwrite_allowlist, read_allowlist
    ...
    async def _execute_skill(self, params: dict) -> str:
        ...
        hook_runner = None
        if skill.hooks:
            from newsclaw.skills.skill_hooks import create_hook_runner
