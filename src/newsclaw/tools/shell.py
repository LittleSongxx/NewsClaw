...
def find_git_bash_path() -> str | None:
    ...
    env_path = os.environ.get("NEWSCLAW_GIT_BASH_PATH")
...
class ShellTool:
    ...
    async def pip_install(self, package: str) -> CommandResult:
        ...
        if spec is not None:
            try:
                from newsclaw.runtime_manager import ensure_execution_env, get_pip_install_args
            ...
            from newsclaw.runtime_manager import get_agent_pip_command
