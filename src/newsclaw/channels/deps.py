...
被以下模块引用:
- newsclaw.main (_ensure_channel_deps)
- newsclaw.setup.wizard (_check_channel_deps)
- newsclaw.setup_center.bridge (ensure-channel-deps)
"""
...
# 通道名 → pyproject.toml extras 名称（用于 pip install newsclaw[xxx] 提示）
