...
``newsclaw-plugin-sdk/src/newsclaw_plugin_sdk`` source tree and prepends
...
- **No imports of newsclaw.*** — plugins/manager imports this at boot, so
...
_SDK_SOURCE_DIRNAME = "newsclaw-plugin-sdk"
...
def ensure_plugin_sdk_on_path() -> Path | None:
    ...
    3. Walk parent directories of this file looking for
       ``<repo>/newsclaw-plugin-sdk/src/newsclaw_plugin_sdk/__init__.py``.
