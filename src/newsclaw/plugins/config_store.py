...
from newsclaw.utils.atomic_io import atomic_json_write, path_transaction_lock, read_json_safe
...
class PluginConfigStore:
    ...
    def _read_locked(self) -> dict[str, Any]:
        if (
            ...
            or self.config_path.with_suffix(self.config_path.suffix + ".bak").is_file()
        ):
