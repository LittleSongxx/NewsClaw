...
When NewsClaw is reachable on the LAN but no web-access password has been
...
Decision delegated to :mod:`newsclaw.api.setup_state`. This module only
...
:func:`newsclaw.api.auth.create_auth_middleware`. With FastAPI's LIFO
