"""
Web access authentication for NewsClaw.
...
REFRESH_COOKIE_NAME = "newsclaw_refresh"
PASSWORD_ENV_VAR = "NEWSCLAW_WEB_PASSWORD"
...
AUTH_EXEMPT_PATHS = frozenset(
    {
        ...
        "/api/logs/frontend",
        "/api/internal/newsclaw/users/status",
    }
)
...
class WebAccessConfig:
    ...
    def has_password_set(self) -> bool:
        ...
        Used by :mod:`newsclaw.api.setup_state` to decide whether the Setup
    ...
    def clear_password(self) -> None:
        ...
        Used by the ``newsclaw reset-password`` CLI. Bumps ``token_version``
...
def is_trusted_local(request: Request) -> bool:
    ...
    :mod:`newsclaw.api.setup_state` — keep them aligned by going through
    this single helper.
    """
