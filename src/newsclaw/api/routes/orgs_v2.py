...
Persistence layer: :mod:`newsclaw.orgs` (JSON file under
...
from newsclaw.orgs.manager import OrgManager, OrgNameConflictError
from newsclaw.orgs.org_models import EdgeType, OrgStatus
from newsclaw.orgs.store import JsonOrgStore
from newsclaw.runtime.models import EdgeKind, OrgV2
...
# ``src/newsclaw/orgs/store.py`` module docstring for the full
# contract.
...
def _resolve_manager_for_writes() -> OrgManager:
    ...
    from newsclaw.orgs.store import _build_default_manager
