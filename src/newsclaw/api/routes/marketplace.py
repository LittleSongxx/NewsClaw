...
from newsclaw.account.desktop import require_marketplace_access, trusted_marketplace_origin
from newsclaw.account.oidc import AccountOIDCManager
from newsclaw.integrations.marketplace import MarketplaceInstallManager
from newsclaw.integrations.marketplace.installer import MarketplaceInstallError
...
def _account(request: Request) -> AccountOIDCManager:
    ...
    if account is None or request.app.state.account_capability.get("mode") != "newsclaw":
