...
from newsclaw.api.schemas import ChatAttachmentRecord
...
def _history_entry(session, conversation_id: str, original_idx: int, msg: dict) -> dict:
    ...
    from newsclaw.core.response_handler import (
    ...
    # bloat sessions.json. See newsclaw.api.message_parts.
    from newsclaw.api.message_parts import (
        build_message_parts,
        normalize_chat_todo,
...
async def generate_title(request: Request, body: GenerateTitleRequest):
    ...
    try:
        ...
        from newsclaw.core.response_handler import strip_thinking_tags
