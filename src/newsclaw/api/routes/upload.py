...
def get_upload_dir() -> Path:
    ...
    if UPLOAD_DIR is None:
        ...
        UPLOAD_DIR = resolve_data_root() / "uploads"
...
def _upload_limit_for(filename: str | None, content_type: str | None) -> int:
    if _is_audio_upload(filename, content_type):
        return _configured_size("NEWSCLAW_MAX_AUDIO_UPLOAD_MB", MAX_AUDIO_UPLOAD_SIZE)
    return _configured_size("NEWSCLAW_MAX_UPLOAD_MB", MAX_UPLOAD_SIZE)
