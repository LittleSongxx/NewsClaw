...
Replaces v1 ``newsclaw.orgs.node_scheduler.OrgNodeScheduler``
...
class NodeSchedulerProtocol(Protocol):
    ...
    Mirrors v1 ``newsclaw.orgs.node_scheduler.OrgNodeScheduler``
...
class OrgNodeScheduler:
    ...
    an :class:`newsclaw.orgs.runtime.OrgRuntime`.
