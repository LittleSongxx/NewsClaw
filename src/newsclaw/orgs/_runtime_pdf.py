...
_ENV_VAR = "NEWSCLAW_ORGS_V2_RENDER_PDF"
...
def _configure_launch() -> dict:
    ...
    try:
        from newsclaw.plugins import sdk  # type: ignore  # noqa: F401
...
async def render_markdown_to_pdf(
    *,
    ...
    footer_html = _FOOTER_TEMPLATE.format(note=_html.escape(footer_note or "NewsClaw 组织编排"))
    try:
