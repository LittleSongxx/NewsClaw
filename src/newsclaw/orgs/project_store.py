...
Replaces v1 ``newsclaw.orgs.project_store.ProjectStore``
...
:mod:`newsclaw.orgs.project_models`); parity tests
...
class ProjectStoreProtocol(Protocol):
    ...
    Mirrors v1 ``newsclaw.orgs.project_store.ProjectStore`` 1:1
...
class JsonProjectStore:
    ...
    ``newsclaw.orgs.project_store.ProjectStore`` byte-for-byte
