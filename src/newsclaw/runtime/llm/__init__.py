"""Focused LLM runtime helpers composed by :mod:`newsclaw.agent.brain`.
...
* :mod:`multimodal` -- pure conversions between ``newsclaw.llm.types``
...
``newsclaw.agent.brain`` composes these helpers around its private runtime base.
"""
