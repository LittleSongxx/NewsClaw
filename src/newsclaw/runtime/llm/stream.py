...
class _LLMClientLike(Protocol):
    """Structural subset of :class:`newsclaw.llm.client.LLMClient` we need."""
...
async def llm_stream_tracking(
    *,
    ...
    """
    from newsclaw.core.token_tracking import TokenTrackingContext
...
async def stream_llm_events(
    ...
    *,
    ...
    Args:
        ...
        messages: already-converted ``newsclaw.llm.types.Message`` list.
