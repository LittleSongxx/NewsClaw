"""Shared :class:`~newsclaw.runtime.supervisor.Supervisor` factory.
...
from newsclaw.agent.supervisor_brain import PassThroughSupervisorBrain
from newsclaw.runtime.cancel_token import CancellationToken
from newsclaw.runtime.checkpoint import BaseCheckpointer, MemoryCheckpointer
from newsclaw.runtime.stream import StreamBus
from newsclaw.runtime.stream_registry import get_or_create_org_stream_bus
...
def get_or_create_checkpointer(
    ...
    *,
    ...
    with _CHECKPOINTER_LOCK:
        ...
        from newsclaw.runtime.backends.sqlite import SqliteCheckpointer
...
def _resolve_speaker_to_node_id(
    ...
    *,
    ...
    if not node_directory:
        return raw
    try:
        from newsclaw.runtime.llm_supervisor_brain import LLMSupervisorBrain
