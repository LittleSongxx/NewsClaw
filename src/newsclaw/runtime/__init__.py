"""NewsClaw v2 runtime package.

Layered orchestration core that replaces ``src/newsclaw/orgs/`` per ADR-0002.

Public surface lives in :mod:`newsclaw.runtime.facade` (added in Phase 6).
