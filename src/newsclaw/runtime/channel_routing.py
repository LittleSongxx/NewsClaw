...
:func:`newsclaw.runtime.state_graph.compile_from_org`.
...
from newsclaw.orgs import OrgNotFound, get_default_store
from newsclaw.runtime.models import NodeV2, OrgV2
from newsclaw.runtime.state_graph import StateGraph, compile_from_org
...
def route_inbound_message_to_v2(*, org_id: str | None) -> RoutingPlan:
    ...
    try:
        ...
        # manager-backed shim (see ``src/newsclaw/orgs/store.py``);
    ...
    *,
    ...
    Keyword Args:
        ...
        brain: optional :class:`SupervisorBrain`; defaults to the
            degenerate one in :mod:`newsclaw.agent.supervisor_brain`.
