...
.. deprecated::
    ...
    pipe their connections through :mod:`newsclaw.storage.safe_sqlite`.
...
class Database:
    ...
    def __init__(self, db_path: Path | None = None):
        warnings.warn(
            "newsclaw.storage.database.Database is legacy; use a subsystem-"
            "specific store routed through newsclaw.storage.safe_sqlite instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    async def connect(self) -> None:
        ...
        Raises :class:`newsclaw.storage.safe_sqlite.SQLiteUnavailable`
