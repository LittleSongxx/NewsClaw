...
from newsclaw.runtime_manager import build_user_subprocess_environment, get_agent_python_executable
...
class SkillHookRunner:
    ...
    def run_hook(
        ...
        *,
        ...
        env["NEWSCLAW_SKILL_ID"] = self._skill_id
        env["NEWSCLAW_HOOK_NAME"] = hook_name
        if env_extra:
