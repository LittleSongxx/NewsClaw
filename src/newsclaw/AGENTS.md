# NewsClaw Core Backend

Python backend for the NewsClaw multi-agent AI assistant.
...
- Sub-agents get an empty context (isolated session `:sub:<run_id>`) plus the task package
