...
The public class composes focused helpers from :mod:`newsclaw.runtime.llm`
...
from newsclaw.core._brain_runtime import Brain as _RuntimeBrainBase
from newsclaw.core._brain_runtime import Context as _RuntimeContext
from newsclaw.core._brain_runtime import Response as _RuntimeResponse
from newsclaw.runtime.llm import (
...
class SupervisorBrain(Protocol):
    ...
    :class:`newsclaw.runtime.state_graph.StateGraph` step. The
...
class Brain(_RuntimeBrainBase):
    ...
    * explicit :class:`SupervisorBrain` protocol conformance with the
    ...
    def llm_client(self) -> Any:
        """Return the borrowed :class:`newsclaw.llm.client.LLMClient`.
