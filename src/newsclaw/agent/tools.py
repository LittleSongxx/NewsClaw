...
from newsclaw.core._tool_runtime import ToolExecutor as _RuntimeToolExecutorBase
from newsclaw.core._tool_runtime import ToolResultWithHint as _RuntimeToolResultWithHint
from newsclaw.core._tool_runtime import ToolSkipped as _RuntimeToolSkipped
from newsclaw.runtime.io import (
...
from newsclaw.runtime.retry_policy import (
    RetryPolicy,
...
class ToolSkipped(_RuntimeToolSkipped):
    ...
    Published under :mod:`newsclaw.agent.tools` and backed by the runtime type.
    """
...
class ToolExecutor(_RuntimeToolExecutorBase):
    ...
    * a public :meth:`is_retriable_error` predicate.
    ...
    def list_overflow_files(directory: str | None = None) -> list[str]:
        ...
        from newsclaw.runtime.io import get_overflow_dir
    ...
    def prune_overflow(self, *, max_files: int | None = None) -> int:
        ...
        from newsclaw.runtime.io import get_overflow_dir, get_overflow_max_files
