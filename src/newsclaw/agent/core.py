...
runtime base. Callers must import it from :mod:`newsclaw.agent`; modules under
``newsclaw.core._*_runtime`` are private implementation details.
"""
...
from newsclaw.core._agent_runtime import (
...
from newsclaw.core.risk_intent import RiskIntentResult
from newsclaw.runtime.desktop.attachments import (
    format_desktop_attachment_reference,
    maybe_inline_local_image,
)
from newsclaw.runtime.state_graph import END, START, StateGraph
...
class Agent(_RuntimeAgentBase):
    ...
    def classify_inbound_risk(self, message: str, intent: Any = None) -> RiskIntentResult:
        ...
        Thin wrapper over
        :func:`newsclaw.agent.safety.destructive_intent.classify_risk_intent`
    ...
    def format_attachment_reference(
        ...
        *,
        ...
        Routes through
        :func:`newsclaw.runtime.desktop.attachments.format_desktop_attachment_reference`
    ...
    def inline_local_image_if_eligible(self, att_url: str, att_mime: str) -> str | None:
        ...
        Routes through
        :func:`newsclaw.runtime.desktop.attachments.maybe_inline_local_image`.
        """
