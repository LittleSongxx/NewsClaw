...
_EXPORTS = {
    ...
    "PendingRiskConfirmation": ("newsclaw.core.confirmation_state", "PendingRiskConfirmation"),
    "PendingRiskConfirmationStore": (
        "newsclaw.core.confirmation_state",
        "PendingRiskConfirmationStore",
    ),
    ...
    "get_confirmation_store": ("newsclaw.core.confirmation_state", "get_confirmation_store"),
