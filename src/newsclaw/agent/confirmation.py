...
because :mod:`newsclaw.core.confirmation_state` imports them while building
...
if TYPE_CHECKING:
    from newsclaw.core.confirmation_state import (
...
def __getattr__(name: str) -> Any:
    if name in {
        ...
        from newsclaw.core import confirmation_state as _confirmation_state
