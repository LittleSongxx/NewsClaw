...
import vip.newsclaw.wiki.dto.RouteResult;
import vip.newsclaw.wiki.dto.RoutedPageMeta;
import vip.newsclaw.wiki.dto.WikiChunkDraft;
import vip.newsclaw.wiki.event.WikiFactPageUpdatedEvent;
import vip.newsclaw.wiki.event.WikiKbDirtyEvent;
import vip.newsclaw.wiki.event.WikiPageCreatedEvent;
import vip.newsclaw.wiki.event.WikiProcessingEvent;
import vip.newsclaw.wiki.job.WikiEmbeddingProviderFailingException;
import vip.newsclaw.wiki.job.WikiJobStage;
...
import vip.newsclaw.wiki.job.WikiModelRoutingService;
...
import vip.newsclaw.wiki.profile.WikiMetadataValidator;
import vip.newsclaw.wiki.profile.WikiPageTypeDef;
import vip.newsclaw.wiki.profile.WikiPageTypeProfile;
...
public class WikiProcessingService {
    ...
    private int processChunkTwoPhase(WikiKnowledgeBaseEntity kb, WikiRawMaterialEntity raw,
        ...
        // newsclaw.wiki.use-structured-route default when the KB hasn't expressed a preference.
