...
/**
 * Thrown by {@link vip.newsclaw.wiki.service.WikiEmbeddingService#embedMissingChunks(Long)}
 * when the embedding provider has failed N batches in a row, where N is
 * controlled by {@code newsclaw.wiki.embedding-consecutive-failure-threshold}.
 *
