package vip.newsclaw.wiki.model;
 ...
 * {@link vip.newsclaw.wiki.hotcache.HotCacheContent}.
 */
@Data
...
public class WikiHotCacheEntity {
    ...
    /** {@link vip.newsclaw.wiki.hotcache.HotCacheUpdateReason#name()} for the most recent rebuild. */
