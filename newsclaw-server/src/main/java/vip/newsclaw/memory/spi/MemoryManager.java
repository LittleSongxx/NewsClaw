package vip.newsclaw.memory.spi;
...
import vip.newsclaw.memory.spi.decorator.MetricsMemoryProvider;
import vip.newsclaw.memory.spi.decorator.RetryableMemoryProvider;
...
public class MemoryManager {
     ...
     * @throws vip.newsclaw.plugin.api.PluginException if an external provider is already registered
     */
    public synchronized void registerPluginProvider(MemoryProvider provider) {
        if (externalPluginProvider != null) {
            throw new vip.newsclaw.plugin.api.PluginException(
