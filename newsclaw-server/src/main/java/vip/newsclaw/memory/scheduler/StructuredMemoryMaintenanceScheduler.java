...
import vip.newsclaw.memory.service.StructuredMemoryConsolidationService;
import vip.newsclaw.memory.service.StructuredMemoryConsolidationService.ConsolidationStats;
...
public class StructuredMemoryMaintenanceScheduler {
    ...
    @Scheduled(cron = "${newsclaw.memory.structured-consolidation-cron:0 30 3 * * ?}")
