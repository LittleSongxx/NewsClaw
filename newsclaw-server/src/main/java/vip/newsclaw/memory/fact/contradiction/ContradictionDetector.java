package vip.newsclaw.memory.fact.contradiction;
...
import vip.newsclaw.memory.service.PromotedEntry;
 ...
 * Gated behind {@code newsclaw.memory.fact.contradiction-check-enabled=false} (default off).
