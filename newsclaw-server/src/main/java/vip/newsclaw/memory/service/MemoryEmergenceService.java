...
import vip.newsclaw.memory.event.DreamCompletedEvent;
import vip.newsclaw.memory.event.DreamFailedEvent;
...
public class MemoryEmergenceService {
    ...
    private final vip.newsclaw.memory.archive.MemoryArchiveService archiveService;
    private final ApplicationEventPublisher eventPublisher;
    private final vip.newsclaw.memory.fact.contradiction.ContradictionDetector contradictionDetector;
