...
import vip.newsclaw.agent.graph.guard.ToolLoopGuard;
...
public class ObservationNode implements NodeAction {
     ...
     * {@link NewsClawStateKeys#ITERATION_REFUND_COUNT}). Mirrors the authoritative
    ...
    public ObservationNode(ObservationProcessor observationProcessor,
                           vip.newsclaw.channel.web.ChatStreamTracker streamTracker) {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        var builder = NewsClawStateAccessor.output()
