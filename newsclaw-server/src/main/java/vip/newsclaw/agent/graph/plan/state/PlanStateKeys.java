 ...
 * <p>
 * 共享键（如 PENDING_EVENTS、CURRENT_PHASE）直接引用 {@link vip.newsclaw.agent.graph.state.NewsClawStateKeys}，
 * 不在此处重复定义。
 *
...
public final class PlanStateKeys {
    ...
    // 注意：PENDING_EVENTS 直接使用 NewsClawStateKeys.PENDING_EVENTS，不在此重复定义
}
