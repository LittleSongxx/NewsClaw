 ...
 */
public final class NewsClawStateAccessor {

    private final OverAllState state;

    public NewsClawStateAccessor(OverAllState state) {
     ...
     * {@code vip.newsclaw.goal.model.GoalEntity}; we reference it by Object
     ...
     * to {@link NewsClawStateKeys#FINAL_ANSWER} via FinalAnswerNode;
