...
public class StateGraphReActAgent extends BaseAgent implements StructuredStreamCapable {
     ...
     * one. Set from {@code newsclaw.agent.reasoning.retention}; defaults to keeping
    ...
    private Map<String, Object> buildInitialState(String userMessage, String conversationId) {
        ...
        String thinkingLevel = vip.newsclaw.llm.chatmodel.ThinkingLevelHolder.get();
    ...
    static boolean shouldEmitStreamedContent(boolean isFinalAnswerTurn,
                                             ...
                                             String streamed, String finalAnswer) {
        if (longFormAccumulation) return false;
