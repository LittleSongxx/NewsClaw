 ...
 * {@code <workspaceBasePath>/.newsclaw/tool-results/<conversationId>/} when a
 * workspace is bound to the agent, otherwise under
 * {@code ${java.io.tmpdir}/newsclaw/tool-results/<conversationId>/}.</p>
 *
 * <pre>
 * mate:
 *   agent:
 ...
 * </pre>
 */
@ConfigurationProperties(prefix = "newsclaw.agent.tool-result")
public class ToolResultProperties {
     ...
     * When blank, falls back to {@code <workspace>/.newsclaw/tool-results/} or
     * {@code ${java.io.tmpdir}/newsclaw/tool-results/}.
     */
