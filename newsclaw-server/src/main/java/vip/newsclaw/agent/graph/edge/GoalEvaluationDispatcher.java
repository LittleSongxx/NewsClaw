...
import static vip.newsclaw.agent.graph.state.NewsClawStateKeys.GOAL_EVALUATED_THIS_RUN;
import static vip.newsclaw.agent.graph.state.NewsClawStateKeys.GOAL_FOLLOWUP_INJECTED;
