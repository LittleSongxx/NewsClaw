package vip.newsclaw.agent.context;
...
public record ChatOrigin(
         ...
         * have no request host; those rely on {@code newsclaw.server.public-base-url}.
         */
        @Nullable String baseUrl,
        /**
         * Immutable numeric id of the NewsClaw user behind this request, when the
         ...
         * senders, cron — which carry no NewsClaw user row. On-behalf-of identity
         * forwarding uses this to tell "NewsClaw authenticated this user" apart
    ...
    public static final String CTX_KEY = "newsclaw.chatOrigin";
     ...
     * on-behalf-of identity forwarding can assert "NewsClaw authenticated this
