...
import vip.newsclaw.agent.graph.executor.ToolResultStorage;
...
public class ConversationWindowManager {
     ...
     * time.
     */
    private vip.newsclaw.channel.web.ChatStreamTracker streamTracker;

    @org.springframework.beans.factory.annotation.Autowired(required = false)
    public void setStreamTracker(vip.newsclaw.channel.web.ChatStreamTracker streamTracker) {
