...
public final class RuntimeContextInjector {
     ...
     * 构建运行时上下文消息（i18n 版本）。
     */
    public static String buildContextMessage(String workspaceBasePath, vip.newsclaw.i18n.I18nService i18n) {
     ...
     */
    public static String buildContextMessage(String workspaceBasePath,
                                              vip.newsclaw.i18n.I18nService i18n,
                                              ChatOrigin origin) {
    ...
    private static void appendSkillRootHintIfPresent(StringBuilder sb, String workspaceBasePath,
                                                      vip.newsclaw.i18n.I18nService i18n) {
        java.nio.file.Path skillRoot = vip.newsclaw.tool.guard.WorkspacePathGuard.getSkillRoot();
        if (skillRoot == null) {
            return;
        }
