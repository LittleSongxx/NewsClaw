    ...
    public static DshRuntimeConfiguration resolve(
        ...
        return new DshRuntimeConfiguration(
                firstNonBlank(managed, properties, environment,
                        "dsh.executable_path", "newsclaw.agent.runtime.dsh.command", "DSH_JSONRPC_AGENT"),
                firstNonBlank(managed, properties, environment,
                        "dsh.cordis_config_path", "newsclaw.agent.runtime.dsh.cordis-config", "DSH_CORDIS_CONFIG"),
                firstNonBlank(managed, properties, environment,
                        "dsh.working_directory", "newsclaw.agent.runtime.dsh.working-directory", "DSH_CWD"),
                firstNonBlank(managed, properties, environment,
                        "dsh.base_url", "newsclaw.agent.runtime.dsh.base-url", "DEEPSEEK_BASE_URL"),
                firstNonBlank(managed, properties, environment,
                        "dsh.model_name", "newsclaw.agent.runtime.dsh.model-name", "DEEPSEEK_MODEL"),
                firstNonBlank(managed, properties, environment,
                        "dsh.api_key", "newsclaw.agent.runtime.dsh.api-key", "DEEPSEEK_API_KEY"));
    }
