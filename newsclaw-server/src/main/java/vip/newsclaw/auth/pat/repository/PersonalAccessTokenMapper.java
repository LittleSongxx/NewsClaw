package vip.newsclaw.auth.pat.repository;
 ...
 *
 * <p>Located under {@code repository} so {@code @MapperScan("vip.newsclaw.**.repository")}
 * (declared on {@code NewsClawApplication}) discovers it; outside that
