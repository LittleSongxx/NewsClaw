package vip.newsclaw.auth.sso.provider;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.benmanes.caffeine.cache.Cache;
import com.github.benmanes.caffeine.cache.Caffeine;
import vip.newsclaw.auth.sso.SsoProperties;
...
public class FeishuSsoProvider implements SsoProvider {
    ...
    private String getAppAccessToken() {
        ...
        try {
            ...
            if (token == null || token.isBlank()) {
                throw new NewsClawException("err.sso.feishu_token_empty",
            ...
            throw new NewsClawException("err.sso.feishu_app_token_failed",
    ...
    private String exchangeUserAccessToken(String code, String appAccessToken) {
        try {
            ...
            if (data == null) {
                throw new NewsClawException("err.sso.feishu_no_data", 502, "飞书未返回 token 数据");
            }
            String token = (String) data.get("access_token");
            if (token == null || token.isBlank()) {
                throw new NewsClawException("err.sso.feishu_user_token_empty",
            ...
            throw new NewsClawException("err.sso.feishu_code_exchange_failed",
    ...
    private SsoUserInfo fetchUserInfo(String userAccessToken) {
        try {
            ...
            Map<String, Object> data = (Map<String, Object>) resp.get("data");
            if (data == null) {
                throw new NewsClawException("err.sso.feishu_no_user_data",
                        502, "飞书未返回用户信息");
            }
            String openId = str(data.get("open_id"));
            if (openId == null || openId.isBlank()) {
                throw new NewsClawException("err.sso.feishu_no_open_id",
            ...
            throw new NewsClawException("err.sso.feishu_user_info_failed",
    ...
    private void checkCode(Map<String, Object> resp, String api) {
        ...
        if (code == null || code != 0) {
            ...
            throw new NewsClawException("err.sso.feishu_api_error",
