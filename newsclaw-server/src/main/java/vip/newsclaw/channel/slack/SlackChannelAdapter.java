package vip.newsclaw.channel.slack;
...
public class SlackChannelAdapter extends AbstractChannelAdapter {
     ...
     * <p>
     * Wired by {@link vip.newsclaw.channel.AsyncTaskMediaDispatcher} so async
