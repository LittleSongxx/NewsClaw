package vip.newsclaw.channel.telegram;
...
public class TelegramChannelAdapter extends AbstractChannelAdapter {
     ...
     * {@link vip.newsclaw.channel.DeliveryOptions#threadId()} is set (Telegram
