package vip.newsclaw.channel.feishu.cards.tool_guard;
...
import vip.newsclaw.channel.feishu.cards.FeishuCardHandler;
...
public class ToolGuardCardHandler implements FeishuCardHandler {
     ...
     * {@link vip.newsclaw.workflow.runtime.ApprovalResumeBridge} then picks up
