...
import vip.newsclaw.channel.notification.ApprovalNotice;

/**
 * Spring-managed factory that produces the tool-guard card kind for
 * {@link vip.newsclaw.channel.feishu.cards.FeishuCardDispatcher}.
 *
...
public class ToolGuardCardKindFactory {
    ...
    public FeishuCardKind<ApprovalNotice> create() {
        ...
        return new FeishuCardKind<>(KIND_NAME, ACTION_PREFIX, ApprovalNotice.class, renderer, handler);
    }
}
