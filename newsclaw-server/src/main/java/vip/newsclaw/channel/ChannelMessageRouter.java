...
import vip.newsclaw.channel.notification.ApprovalNotificationService;
import vip.newsclaw.channel.service.ChannelService;
import vip.newsclaw.channel.web.AgentStreamAccumulator;
...
public class ChannelMessageRouter {
    ...
    @Autowired(required = false)
    private vip.newsclaw.tool.document.GeneratedFileCache generatedFileCache;
     ...
     *       a {@link NewsClawException} with {@code msgKey="err.channel.not_found"}.
