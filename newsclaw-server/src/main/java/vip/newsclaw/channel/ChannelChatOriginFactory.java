 ...
 * {@link ChatOrigin}. Lives in {@code vip.newsclaw.channel} (not in
 * {@code vip.newsclaw.agent.context}) so that the dependency direction stays
...
public class ChannelChatOriginFactory {
    ...
    public ChatOrigin from(ChannelEntity channel,
        ...
        return new ChatOrigin(
                ...
                /* requesterUserId   */ null);  // IM senders are external platform ids, not NewsClaw accounts
    }
