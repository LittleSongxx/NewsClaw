package vip.newsclaw.tool.model3d.provider;
...
import vip.newsclaw.task.AsyncTaskService.TaskPollResult;
import vip.newsclaw.tool.model3d.Model3dCapability;
import vip.newsclaw.tool.model3d.Model3dGenerationProvider;
import vip.newsclaw.tool.model3d.Model3dGenerationRequest;
import vip.newsclaw.tool.model3d.Model3dProviderCapabilities;
import vip.newsclaw.tool.model3d.Model3dSubmitResult;
 ...
 *   <li>Concurrency: 1 task by default — {@link vip.newsclaw.tool.ConcurrencyUnsafe} on the tool ensures the agent doesn't fire two in parallel</li>
 * </ul>
 *
