package vip.newsclaw.tool.local;
 ...
 * NewsClaw desktop app, which enforces a directory whitelist, prompts the user
...
public class LocalFileTools {
    ...
    @Tool(description = """
            ...
            Requires the NewsClaw desktop app to be connected and the path to be \
