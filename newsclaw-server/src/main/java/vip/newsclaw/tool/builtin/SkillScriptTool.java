...
import vip.newsclaw.agent.context.AgentWorkspaceResolver;
import vip.newsclaw.agent.context.ChatOrigin;
import vip.newsclaw.llm.routing.AgentBindingResolver;
import vip.newsclaw.skill.runtime.SkillFileAccessPolicy;
import vip.newsclaw.skill.runtime.SkillRuntimeService;
import vip.newsclaw.skill.runtime.SkillScriptExecutionService;
...
public class SkillScriptTool {
    ...
    @vip.newsclaw.tool.ConcurrencyUnsafe("script execution can have arbitrary side effects on the host process and filesystem")
    @Tool(description = """
