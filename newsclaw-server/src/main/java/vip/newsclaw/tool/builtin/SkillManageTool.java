...
import vip.newsclaw.skill.event.SkillAuthoredEvent;
...
public class SkillManageTool {
    ...
    @vip.newsclaw.tool.ConcurrencyUnsafe("create/edit/patch/delete on the shared skill registry; concurrent ops on the same skill name race")
    @Tool(description = """
