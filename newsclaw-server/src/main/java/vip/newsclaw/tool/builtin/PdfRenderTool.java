...
import vip.newsclaw.tool.document.FilenameSanitizer;
import vip.newsclaw.tool.document.GeneratedFileCache;
import vip.newsclaw.tool.document.GeneratedFileLink;
import vip.newsclaw.tool.document.MarkdownInputResolver;
import vip.newsclaw.tool.document.MarkdownInputResolver.Resolved;
import vip.newsclaw.tool.document.MarkdownInputResolver.ResolveException;
import vip.newsclaw.tool.document.pdf.MarkdownPdfRenderer;
import vip.newsclaw.tool.document.pdf.PdfProperties;
...
public class PdfRenderTool {
    ...
    @Tool(description = """
        ...
        **Do NOT bypass this tool by shelling out to `chrome --headless --print-to-pdf`,
        ...
        a PDF on local disk that is NOT registered in newsclaw's download cache, so
