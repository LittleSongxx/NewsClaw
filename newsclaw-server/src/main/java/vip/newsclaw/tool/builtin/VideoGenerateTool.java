...
import vip.newsclaw.tool.video.*;
...
public class VideoGenerateTool {
    ...
    @vip.newsclaw.tool.ConcurrencyUnsafe("creates async tasks and persists generated artifacts; provider rate limits also forbid parallel calls")
