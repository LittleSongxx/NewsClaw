package vip.newsclaw.tool.image.vision.provider;
...
import vip.newsclaw.tool.image.vision.ImageVisionProvider;
import vip.newsclaw.tool.image.vision.VisionContext;
import vip.newsclaw.tool.image.vision.VisionRequest;
import vip.newsclaw.tool.image.vision.VisionResult;
...
public abstract class OpenAiCompatibleVisionProvider implements ImageVisionProvider {
    ...
    public VisionResult caption(VisionRequest request, SystemSettingsDTO settings) {
        ...
        try {
            ...
            throw new NewsClawException("err.wiki.vision.provider_failed",
