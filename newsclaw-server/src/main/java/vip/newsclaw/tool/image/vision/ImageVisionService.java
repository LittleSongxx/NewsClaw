package vip.newsclaw.tool.image.vision;
...
import vip.newsclaw.wiki.model.WikiImageCaptionCacheEntity;
import vip.newsclaw.wiki.service.WikiImageCaptionCacheService;
 ...
 *       success metrics.</li>
 *   <li>If every provider fails, throw a {@link NewsClawException} carrying
...
public class ImageVisionService {
     ...
     *
     * @throws NewsClawException with key {@code err.wiki.vision.disabled} when the feature flag is off
     * @throws NewsClawException with key {@code err.wiki.vision.no_provider} when no provider is available
     * @throws NewsClawException with key {@code err.wiki.vision.all_failed} when every provider failed
     */
    public VisionResult caption(VisionRequest request) {
        ...
        if (!featureFlagService.isEnabled(FEATURE_FLAG)) {
            throw new NewsClawException("err.wiki.vision.disabled",
        ...
        if (available.isEmpty()) {
            throw new NewsClawException("err.wiki.vision.no_provider",
        ...
        if (winner == null) {
            ...
            throw new NewsClawException("err.wiki.vision.all_failed",
