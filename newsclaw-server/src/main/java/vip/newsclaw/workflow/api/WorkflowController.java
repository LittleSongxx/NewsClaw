package vip.newsclaw.workflow.api;
...
import vip.newsclaw.workflow.compiler.WorkflowCompileFailedException;
...
public class WorkflowController {
    ...
    @RequireWorkspaceRole("admin")
    public R<List<vip.newsclaw.workflow.draftgen.WorkflowDraftTemplate>> listDraftTemplates() {
    ...
    private static R<CompileErrorResponse> buildCompileFailure(List<vip.newsclaw.workflow.compiler.CompileError> errors) {
