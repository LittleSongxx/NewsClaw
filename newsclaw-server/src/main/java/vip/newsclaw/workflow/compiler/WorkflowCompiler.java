package vip.newsclaw.workflow.compiler;
...
public class WorkflowCompiler {
    ...
    private List<CompileError> checkExpressionSyntax(WorkflowGraph graph) {
        ...
        for (int i = 0; i < graph.steps().size(); i++) {
            ...
            if (step.mode() instanceof vip.newsclaw.workflow.compiler.ir.StepMode.Conditional c
            ...
            if (step.mode() instanceof vip.newsclaw.workflow.compiler.ir.StepMode.DispatchChannel d
            ...
            if (step.mode() instanceof vip.newsclaw.workflow.compiler.ir.StepMode.WriteMemory w
