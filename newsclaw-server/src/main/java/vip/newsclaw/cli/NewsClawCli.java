...
/**
 * NewsClaw CLI framework — single-file core containing:
 * <ul>
 ...
 * <pre>{@code
 *   @Component
 *   public class MyCommand implements NewsClawCli.CliCommand {
 *       public String name()        { return "mycmd"; }
 *       public String description() { return "does something"; }
 *       public String usage()       { return "  --cli.x=...\n  example: ..."; }
 *       public void execute(NewsClawCli.CliContext ctx) {
 *           ctx.exit(0);
 *       }
 *   }
 * }</pre>
 */
public final class NewsClawCli { private NewsClawCli() { /* namespace */ }
