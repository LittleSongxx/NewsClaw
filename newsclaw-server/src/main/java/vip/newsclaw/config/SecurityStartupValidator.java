...
public class SecurityStartupValidator implements ApplicationRunner {
    ...
    private static final String DEFAULT_JWT_SECRET = "NewsClaw-JWT-Secret-Key-2024-Please-Change-In-Production";
    ...
    public void run(ApplicationArguments args) {
        ...
        if ("*".equals(corsOrigins.trim())) {
            log.warn("[Security] CORS allows all origins. Set NEWSCLAW_CORS_ALLOWED_ORIGINS in production.");
            hasWarnings = true;
        }
