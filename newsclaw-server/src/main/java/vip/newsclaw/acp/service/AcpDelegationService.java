...
import vip.newsclaw.acp.client.AcpStdioClient;
 ...
 * </ol>
 *
 * <p>The streaming surface (chunk-by-chunk relay back through NewsClaw's
...
public class AcpDelegationService {
     ...
     * {@link NewsClawException} for configuration / runtime errors so
    ...
    public String prompt(String endpointName, String userPrompt, String cwdHint, Long workspaceId) {
        ...
        if (userPrompt == null || userPrompt.isBlank()) {
            throw new NewsClawException("err.acp.prompt_required",
        ...
        if (!Boolean.TRUE.equals(endpoint.getEnabled())) {
            throw new NewsClawException("err.acp.endpoint_disabled",
        ...
        try (AcpStdioClient autoClose = client) {
            ...
            if (initResp == null || initResp.path("protocolVersion").asInt(-1)
                ...
                throw new NewsClawException("err.acp.protocol_mismatch",
            ...
            if (sessionId == null || sessionId.isBlank()) {
                throw new NewsClawException("err.acp.session_failed",
            ...
            if (authHint != null) {
                throw new NewsClawException("err.acp.auth_failed", authHint);
            }
            throw new NewsClawException("err.acp.delegation_failed",
