package vip.newsclaw.acp.model;
 ...
 *
 * <p>Each row describes one external coding agent that NewsClaw can
...
public class AcpEndpointEntity {
     ...
     * renders ACP tool-call events into NewsClaw's stream protocol.
     */
