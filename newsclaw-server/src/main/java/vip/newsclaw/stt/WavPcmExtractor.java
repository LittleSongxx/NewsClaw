 ...
 * {@code newsclaw-ui/src/utils/wavEncoder.ts}) emits a 16 kHz mono 16-bit
 ...
 * NewsClaw's WavRecorder. WAVs with extra chunks (LIST, JUNK, …) before the
...
public final class WavPcmExtractor {
    ...
    /**
     * True only for the 44-byte PCM16/mono layout produced by NewsClaw's web
