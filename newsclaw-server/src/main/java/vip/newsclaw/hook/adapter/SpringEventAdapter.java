package vip.newsclaw.hook.adapter;
...
import vip.newsclaw.hook.event.MemoryEvent;
import vip.newsclaw.hook.event.SessionEvent;
import vip.newsclaw.hook.event.WikiEvent;
