package vip.newsclaw.workspace.conversation.controller;
...
import vip.newsclaw.team.service.TeamWorkerConversationGovernanceService;
...
public class ConversationController {
    ...
    public R<?> listMessages(@PathVariable String conversationId,
        ...
        // 分页模式
        java.util.List<vip.newsclaw.workspace.conversation.model.MessageEntity> messages;
        boolean hasMore;
        ...
        java.util.List<vip.newsclaw.workspace.conversation.vo.MessageVO> views = messages.stream()
                .map(m -> vip.newsclaw.workspace.conversation.vo.MessageVO.from(
