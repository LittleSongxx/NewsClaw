package vip.newsclaw.workspace.core.config;
 ...
 * {@link vip.newsclaw.tool.guard.WorkspacePathGuard}. When a conversation has no
 ...
 */
@Data
@ConfigurationProperties(prefix = "newsclaw.workspace.sandbox")
