 ...
 * @param modelName  model identifier used for traceability; may be null for legacy callers
 */
public record FallbackEntry(String providerId, ChatModel chatModel, String modelName) {

    /** Source-compatible constructor for existing callers and tests. */
    public FallbackEntry(String providerId, ChatModel chatModel) {
        this(providerId, chatModel, null);
    }
}
