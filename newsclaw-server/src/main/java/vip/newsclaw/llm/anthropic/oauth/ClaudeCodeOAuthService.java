package vip.newsclaw.llm.anthropic.oauth;
 ...
 * RFC-062 PR-4. Until then, NewsClaw piggybacks on whatever credentials the
...
public class ClaudeCodeOAuthService {
     ...
     *
     * @throws NewsClawException with key {@code err.anthropic.no_claude_code}
    ...
    public String getValidToken() {
        ClaudeCodeCredentials creds = reader.read()
                .orElseThrow(() -> new NewsClawException("err.anthropic.no_claude_code",
        ...
        if (!creds.canRefresh()) {
            throw new NewsClawException("err.anthropic.token_expired_no_refresh",
