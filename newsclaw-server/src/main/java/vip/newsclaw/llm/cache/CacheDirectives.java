package vip.newsclaw.llm.cache;
...
public record CacheDirectives(
        ...
        CacheTtl ttl,
        vip.newsclaw.llm.model.ModelProtocol protocol) {
    ...
    public static CacheDirectives empty(vip.newsclaw.llm.model.ModelProtocol protocol) {
