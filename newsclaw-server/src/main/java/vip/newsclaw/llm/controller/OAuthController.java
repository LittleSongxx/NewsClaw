package vip.newsclaw.llm.controller;
...
import vip.newsclaw.llm.oauth.OpenAIDeviceCodeService;
import vip.newsclaw.llm.oauth.OpenAIDeviceCodeService.DeviceCodePollResult;
import vip.newsclaw.llm.oauth.OpenAIDeviceCodeService.DeviceCodeStartResult;
import vip.newsclaw.llm.oauth.OpenAIOAuthService;
import vip.newsclaw.llm.oauth.OpenAIOAuthService.OAuthAuthorizeResult;
import vip.newsclaw.llm.oauth.OpenAIOAuthService.OAuthStatusResult;
...
public class OAuthController {
     ...
     * 粘贴给 NewsClaw 完成 token 交换。Server 部署在 Linux / 远程 host 时唯一可用路径，
