...
public class AcpSkillWrapperToolFactory {
     ...
     * building them. Used by {@link vip.newsclaw.skill.runtime.SkillPackageResolver}
     * to populate {@code manifest.allowedTools} so
     * {@link vip.newsclaw.skill.runtime.model.ResolvedSkill#getEffectiveAllowedTools()}
