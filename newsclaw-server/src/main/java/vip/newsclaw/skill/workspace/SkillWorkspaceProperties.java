 ...
 */
@Data
@ConfigurationProperties(prefix = "newsclaw.skill.workspace")
public class SkillWorkspaceProperties {

    /**
     * 工作区根目录，默认 ${user.home}/.newsclaw/skills
     * 每个 skill 按名称在此目录下创建子目录：{root}/{skillName}/
     */
    private String root = System.getProperty("user.home") + "/.newsclaw/skills";
