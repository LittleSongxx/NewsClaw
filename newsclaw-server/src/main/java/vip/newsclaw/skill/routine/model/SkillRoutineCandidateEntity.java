package vip.newsclaw.skill.routine.model;
...
public class SkillRoutineCandidateEntity {
    ...
    /** A synthesized Skill waits in the proposal approval queue. */
    ...
    /** {@code observing} | {@code proposed} | {@code promoted} | {@code dismissed}. */
    ...
    /** Reviewable Skill proposal id, populated before a live Skill is created. */
    @TableField(value = "proposal_id", updateStrategy = FieldStrategy.ALWAYS)
