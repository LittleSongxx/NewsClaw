package vip.newsclaw.skill.template;
...
import vip.newsclaw.skill.workspace.bundle.ClasspathBundleSource;
import vip.newsclaw.skill.workspace.bundle.MaterializeOptions;
import vip.newsclaw.skill.workspace.bundle.SkillBundleMaterializer;
import vip.newsclaw.skill.workspace.bundle.SkillBundleSource;
...
public class SkillTemplateService {
    ...
    public SkillEntity instantiate(String templateId, Map<String, Object> values, Long workspaceId) {
        ...
        if (template == null) {
            throw new NewsClawException("err.skill_template.not_found",
        ...
        for (SkillTemplate.TemplateField field : template.getFields()) {
            ...
            if ((resolved == null || resolved.isBlank())) {
                if (field.getDefaultValue() != null) {
                    ...
                    throw new NewsClawException("err.skill_template.missing_field",
