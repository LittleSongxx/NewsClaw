...
import vip.newsclaw.skill.installer.SkillInstaller;
import vip.newsclaw.workspace.core.annotation.RequireWorkspaceRole;
import vip.newsclaw.skill.installer.ZipSkillFetcher;
...
public class SkillInstallController {
    ...
    @Value("${newsclaw.skill.upload.max-entry-size-mb:1}")
    ...
    @Value("${newsclaw.skill.upload.max-total-size-mb:50}")
