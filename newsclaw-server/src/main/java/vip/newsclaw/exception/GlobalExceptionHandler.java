 ...
 * <p>
 * NewsClawException messages are translated through I18nService when the
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NewsClawException.class)
    public ResponseEntity<R<Void>> handleNewsClawException(NewsClawException e) {
     ...
     */
    private String translateExceptionMsg(NewsClawException e) {
