...
import vip.newsclaw.kbopen.dto.KbOpenApiDtos.*;
import vip.newsclaw.kbopen.service.KbOpenApiService;
import vip.newsclaw.wiki.dto.PageCitationWithRaw;
import vip.newsclaw.wiki.dto.PageSearchResult;
...
public class KbOpenApiController {
    ...
    public R<PageCard> getPage(
        ...
        if (page == null) {
            throw new NewsClawException(404, "Page not found: " + slug);
        }
