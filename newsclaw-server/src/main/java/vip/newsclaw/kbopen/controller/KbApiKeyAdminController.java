...
import vip.newsclaw.kbopen.auth.KbApiKeyService;
import vip.newsclaw.kbopen.auth.KbApiKeyService.CreatedKey;
...
public class KbApiKeyAdminController {
    ...
    private UserEntity requireUser(Authentication auth) {
        ...
        if (user == null) {
            throw new NewsClawException("err.auth.user_not_found",
