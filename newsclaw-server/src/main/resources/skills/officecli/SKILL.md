...
This skill supplements NewsClaw's native Office renderers. It never replaces them.
...
- Do not install OfficeCLI from inside a chat. If the dependency is missing, explain that an administrator must install it on the NewsClaw server.
