...
This skill is designed for the the agent agent. It uses the agent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other the agent skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.newsclaw/plans/` | `skill_view("plan")` |
