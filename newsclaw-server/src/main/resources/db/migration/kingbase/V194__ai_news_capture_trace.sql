...
ALTER TABLE mate_ai_news_event_evidence ADD COLUMN IF NOT EXISTS fetched_at TIMESTAMP(3);
...
ALTER TABLE mate_ai_news_event_evidence ADD COLUMN IF NOT EXISTS redirect_chain_json TEXT;
