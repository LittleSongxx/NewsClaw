...
class SkillControllerVirtualGuardTest {
    ...
    void mutationFamilyAllGuarded() {
        long virtualId = McpSkillBridge.VIRTUAL_ID_BASE + 42L;
        assertThrows(NewsClawException.class, () -> controller.delete(virtualId, null));
        assertThrows(NewsClawException.class, () -> controller.rescan(virtualId, null));
    }
    ...
    void realIdNotGuarded() {
        ...
        SkillController real = new SkillController(
                mock(vip.newsclaw.skill.service.SkillService.class),
                null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, null, null, null, null, null);
        ...
        // A virtual-id call would have thrown NewsClawException before
        // reaching the service.
        try {
            real.update(snowflakeId, new SkillEntity(), null);
        } catch (NewsClawException e) {
            // The guard message contains "MCP/ACP"; any other NewsClawException
