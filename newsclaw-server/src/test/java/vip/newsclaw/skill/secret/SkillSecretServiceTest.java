...
class SkillSecretServiceTest {
    ...
    void rejectsBadKeys() {
        assertThrows(NewsClawException.class, () -> service.put(1L, "with-dash", "v"));
        assertThrows(NewsClawException.class, () -> service.put(1L, "1leading-digit", "v"));
        assertThrows(NewsClawException.class, () -> service.put(1L, "", "v"));
        assertThrows(NewsClawException.class, () -> service.put(1L, null, "v"));
        assertThrows(NewsClawException.class, () -> service.put(null, "FOO", "v"));
        verifyNoInteractions(mapper);
    }
