...
class SkillChangeProposalServiceTest {
    ...
    void blockedProposalCannotBeApprovedOrApplied() {
        ...
        assertThrows(NewsClawException.class, () -> service.approve(7L, proposal.getId(), null));
        assertThrows(NewsClawException.class, () -> service.apply(7L, proposal.getId()));
    ...
    void patchRequiresOneExactTargetAndPersistsDiff() {
        ...
        assertThrows(NewsClawException.class, () -> service.propose(new SkillProposalDraft(7L, 3L,
                "REFLECTION", "conv-1", null, "patch", "ai-news-radar", null,
