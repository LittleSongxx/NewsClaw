...
class WorkspaceMemorySearchTest {
    ...
    void saveFilePublishesChangeEvent() {
        ...
        ArgumentCaptor<vip.newsclaw.workspace.document.event.WorkspaceFileChangedEvent> captor =
                ArgumentCaptor.forClass(vip.newsclaw.workspace.document.event.WorkspaceFileChangedEvent.class);
