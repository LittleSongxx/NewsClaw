 ...
 *       surface as a {@code NewsClawException("err.mcp.not_found")} which
...
class McpServerServiceListToolsTest {
    ...
    @Test
    @DisplayName("missing server id throws NewsClawException — distinguishes not-found from empty-tools")
