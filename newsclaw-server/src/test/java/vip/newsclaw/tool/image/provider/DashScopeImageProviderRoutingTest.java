...
class DashScopeImageProviderRoutingTest {
    ...
    void providerDeclaresBothCapabilities() {
        ...
        assertTrue(caps.contains(vip.newsclaw.tool.image.ImageCapability.TEXT_TO_IMAGE));
        assertTrue(caps.contains(vip.newsclaw.tool.image.ImageCapability.IMAGE_EDIT));
    }
}
