package vip.newsclaw.tool.document;
 ...
 * when {@code newsclaw.server.public-base-url} is set the URL is absolute, and
...
class GeneratedFileUrlTest {
    ...
    void absoluteWhenConfigured() {
        ReflectionTestUtils.setField(cache, "publicBaseUrl", "https://newsclaw.example.com/");
        String url = cache.downloadUrl("abc-123");
        assertEquals("https://newsclaw.example.com/api/v1/files/generated/abc-123", url);
    }
    ...
    void absoluteFromToolContext() {
        ...
        ToolContext ctx = vip.newsclaw.agent.context.ChatOrigin
    ...
    void patternMatchesAbsolute() {
        Matcher m = GeneratedFileCache.GENERATED_URL_PATTERN
                .matcher("see https://newsclaw.example.com/api/v1/files/generated/xy-9 now");
        assertTrue(m.find());
        assertEquals("xy-9", m.group(1), "id group must exclude the scheme://host prefix");
        assertEquals("https://newsclaw.example.com/api/v1/files/generated/xy-9", m.group(0),
    ...
    void scrubAbsoluteFakeLeavesNoHost() {
        String text = "下载: https://newsclaw.example.com/api/v1/files/generated/"
                + "00000000-0000-0000-0000-000000000000";
        String scrubbed = cache.scrubMissingReferences(text);
        assertFalse(scrubbed.contains("/api/v1/files/generated/"));
        assertFalse(scrubbed.contains("newsclaw.example.com"),
    ...
    void scrubAbsoluteLivePassesThrough() {
        ...
        String text = "下载: https://newsclaw.example.com/api/v1/files/generated/" + id;
