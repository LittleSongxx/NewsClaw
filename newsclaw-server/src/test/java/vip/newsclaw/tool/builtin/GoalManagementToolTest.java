...
class GoalManagementToolTest {
    ...
    @Mock private vip.newsclaw.channel.web.ChatStreamTracker streamTracker;
    ...
    void completeGoal_happyPath_callsMarkCompleted() {
        ...
        when(goalService.toResponse(any())).thenReturn(new vip.newsclaw.goal.model.GoalResponse());
        String result = tool.completeGoal(ctxWith("conv-1", 10L, "alice"));
