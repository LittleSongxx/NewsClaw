package vip.newsclaw.stt.provider;
...
import vip.newsclaw.stt.SttRequest;
import vip.newsclaw.stt.SttResult;
import vip.newsclaw.stt.SttTransportConfig;
import vip.newsclaw.stt.transport.OpenAiCompatibleSttTransport;
...
class OpenAiSttProviderTest {
    ...
    void missingProviderIsSurfacedAsTypedFailure() {
        ...
        when(modelProviderService.getProviderConfig("does-not-exist"))
                .thenThrow(new NewsClawException("err.llm.provider_not_found", "missing"));
