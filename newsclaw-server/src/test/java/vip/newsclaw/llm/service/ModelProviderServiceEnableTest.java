...
import vip.newsclaw.llm.model.CreateCustomProviderRequest;
import vip.newsclaw.llm.model.EnableResult;
...
class ModelProviderServiceEnableTest {
    ...
    void disableWhenNoDefaultExists() {
        ...
        when(modelConfigService.getDefaultModel())
                .thenThrow(new NewsClawException("err.test.no_default", "no default"));
