...
class WikiOverviewSpliceTest {
    ...
    void setUp() {
        ...
        service = new WikiOverviewService(
                ...
                mock(vip.newsclaw.wiki.repository.WikiPageMapper.class),
                mock(vip.newsclaw.wiki.repository.WikiRawMaterialMapper.class),
                mock(vip.newsclaw.wiki.repository.WikiChunkMapper.class),
