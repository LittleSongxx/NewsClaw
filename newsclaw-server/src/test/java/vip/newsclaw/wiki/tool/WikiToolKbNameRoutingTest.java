...
class WikiToolKbNameRoutingTest {
    ...
    private final vip.newsclaw.wiki.service.WikiPageTypePermissionService permissionService =
            new vip.newsclaw.wiki.service.WikiPageTypePermissionService(
                    mock(vip.newsclaw.wiki.repository.WikiAgentPageTypePermissionMapper.class), kbService, objectMapper);
