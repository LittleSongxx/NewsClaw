package vip.newsclaw.approval.grant;
...
import vip.newsclaw.approval.grant.AutoApproveAuditLogger;
import vip.newsclaw.approval.grant.AutoApproveResult;
import vip.newsclaw.approval.grant.AutoGrantSafetyFloor;
...
import vip.newsclaw.tool.guard.model.GuardFinding;
import vip.newsclaw.tool.guard.model.GuardSeverity;
...
class ApprovalGrantResolverTest {
    ...
    void all_distinct_non_null_rule_ids_become_candidates() {
        ...
        GuardEvaluation eval = new GuardEvaluation(
                ...
                vip.newsclaw.tool.guard.model.GuardDecision.NEEDS_APPROVAL, null);
