...
import vip.newsclaw.memory.fact.extraction.PatternEntityExtractor;
...
class FactProjectionInvariantTest {
    ...
    void rebuildAfterBumpUseCount_preservesAccumulatedColumns() {
        ...
        var fact = new vip.newsclaw.memory.fact.model.FactEntity();
        fact.setUseCount(42);
    ...
    void factMapper_noDirectAccumulatedColumnWrite() {
        ...
        for (var method : vip.newsclaw.memory.fact.repository.FactMapper.class.getDeclaredMethods()) {
