...
import vip.newsclaw.team.model.TeamRunStatus;
...
class TeamTasksToolTest {
    ...
    @Test
    @DisplayName("direct completion registers generated package links on a deliverable task")
    void completeAutoAttachesGeneratedDeliverables() {
        callerIs(MEMBER_ID);
        TeamTaskEntity running = task(5L, TeamTaskStatus.IN_PROGRESS);
        ...
        when(taskService.completeTask(5L, MEMBER_ID, """
                已完成。
                [公众号预览.html](http://localhost:18080/api/v1/files/generated/preview-1)
                [公众号素材.zip](http://localhost:18080/api/v1/files/generated/bundle-1)
                """)).thenReturn(List.of());
        ...
        String result = """
                ...
                [公众号素材.zip](http://localhost:18080/api/v1/files/generated/bundle-1)
                """;
        String out = tool.team_tasks("complete", "5", null, null, null, null, null, null,
                null, null, null, result, null, null, null, null, null, null, null);

        assertTrue(out.startsWith("✓ Task #3"));
        verify(taskService).addDeliverable(5L, MEMBER_ID, "公众号预览.html",
                "http://localhost:18080/api/v1/files/generated/preview-1");
        verify(taskService).addDeliverable(5L, MEMBER_ID, "公众号素材.zip",
                "http://localhost:18080/api/v1/files/generated/bundle-1");
        verify(taskService).completeTask(5L, MEMBER_ID, result);
    }

    @Test
    @DisplayName("deliverable-required tasks cannot self-complete with prose only")
    void completeRejectsMissingRequiredDeliverable() {
        callerIs(MEMBER_ID);
        TeamTaskEntity running = task(5L, TeamTaskStatus.IN_PROGRESS);
        running.setOwnerAgentId(MEMBER_ID);
        running.setMetadata("{\"deliverableRequired\":true}");
        ...
        String out = tool.team_tasks("complete", "5", null, null, null, null, null, null,
                null, null, null, "only a prose summary", null, null, null, null, null, null, null);

        assertTrue(out.contains("requires a generated deliverable"));
