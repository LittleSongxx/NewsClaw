package vip.newsclaw.agent.binding;
...
class AgentBindingServiceValidationTest {
    ...
    void setUp() {
        ...
        service = new AgentBindingService(
                ...
                mock(vip.newsclaw.agent.binding.repository.AgentWikiKbBindingMapper.class),
                mock(vip.newsclaw.wiki.repository.WikiKnowledgeBaseMapper.class),
                skillRuntimeService,
