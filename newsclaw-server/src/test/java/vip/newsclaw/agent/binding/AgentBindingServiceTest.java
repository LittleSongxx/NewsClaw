...
class AgentBindingServiceTest {
    ...
    void bindSkillAllowsVirtualMcpSkill() {
        ...
        long virtualMcpId = vip.newsclaw.skill.mcp.McpSkillBridge.VIRTUAL_ID_BASE + 42L;
    ...
    void bindSkillAllowsVirtualAcpSkillSameWorkspace() {
        ...
        long virtualAcpId = vip.newsclaw.skill.acp.AcpSkillBridge.VIRTUAL_ID_BASE + endpointId;
     ...
     * {@link vip.newsclaw.tool.service.AvailableToolService#listAvailable()}
