...
class CompactAgedToolResponsesTest {
    ...
    void spillPathPreserved() {
        String body = spillBody("browser_use", "/tmp/newsclaw/tool-results/conv-1/tool_abc.txt");
        List<Message> in = List.of(
        ...
        assertTrue(compacted.contains("/tmp/newsclaw/tool-results/conv-1/tool_abc.txt"),
