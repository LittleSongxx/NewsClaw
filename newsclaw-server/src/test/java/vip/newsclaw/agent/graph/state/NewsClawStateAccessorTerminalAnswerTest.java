package vip.newsclaw.agent.graph.state;
 ...
 * </ul>
 */
class NewsClawStateAccessorTerminalAnswerTest {
    ...
    void reactPath_returnsFinalAnswer() {
        ...
        assertEquals("ReAct answer", new NewsClawStateAccessor(s).terminalAnswer());
    }

    @Test
    void planExecuteLongPath_returnsFinalSummary() {
        OverAllState s = mockState("", "Plan summary text", "");
        assertEquals("Plan summary text", new NewsClawStateAccessor(s).terminalAnswer());
    }

    @Test
    void planExecuteShortPath_returnsDirectAnswer() {
        OverAllState s = mockState("", "", "Direct quick answer");
        assertEquals("Direct quick answer", new NewsClawStateAccessor(s).terminalAnswer());
    }

    @Test
    void allEmpty_returnsEmptyString() {
        OverAllState s = mockState("", "", "");
        assertEquals("", new NewsClawStateAccessor(s).terminalAnswer());
    }
