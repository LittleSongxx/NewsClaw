...
class ToolCallbackToolContextForwardArchTest {
    ...
    private static final JavaClasses NEWSCLAW_CLASSES = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("vip.newsclaw");
    ...
    void cronJobRunnerMustNotCarryTransactional() {
        noClasses()
                ...
                .and().resideInAPackage("vip.newsclaw.cron..")
