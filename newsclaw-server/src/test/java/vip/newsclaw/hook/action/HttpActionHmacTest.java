package vip.newsclaw.hook.action;
...
class HttpActionHmacTest {
    ...
    @Test
    @DisplayName("default signature header constant matches NewsClaw convention")
    void defaultHeaderName() {
        assertEquals("X-NewsClaw-Signature", HttpAction.DEFAULT_SIGNATURE_HEADER);
    }
}
