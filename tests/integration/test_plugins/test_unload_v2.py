...
from newsclaw.plugins import installer
from newsclaw.plugins.manager import PluginManager
from newsclaw.plugins.manifest import BASIC_PERMISSIONS
from newsclaw.plugins.state import PluginState
...
async def test_async_on_unload_is_awaited(tmp_path: Path) -> None:
    ...
    body = textwrap.dedent(f"""\
        from pathlib import Path
        from newsclaw.plugins.api import PluginBase
