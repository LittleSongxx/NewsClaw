...
class TestTelegramAdapterInit:
    ...
    def test_import_succeeds(self):
        from newsclaw.channels.adapters.telegram import TelegramAdapter
...
class TestDingTalkAdapterInit:
    def test_import_succeeds(self):
        from newsclaw.channels.adapters.dingtalk import DingTalkAdapter
...
class TestOneBotAdapterInit:
    def test_import_succeeds(self):
        from newsclaw.channels.adapters.onebot import OneBotAdapter
...
class TestWeWorkAdapterInit:
    def test_import_succeeds(self):
        from newsclaw.channels.adapters.wework_bot import WeWorkBotAdapter
