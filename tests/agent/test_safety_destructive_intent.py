...
from newsclaw.agent.safety import destructive_intent as di
from newsclaw.core.risk_intent import RiskIntentResult, RiskLevel, TargetKind
...
def test_package_exports_are_stable() -> None:
    ...
    from newsclaw.agent.safety import __all__ as pkg_all
    expected = {
        "DESTRUCTIVE_VERBS",
