...
def test_cache_control_injected_for_dashscope_qwen35():
    ...
    """
    from newsclaw.llm.cache import SYSTEM_PROMPT_DYNAMIC_BOUNDARY
    from newsclaw.llm.providers.openai import OpenAIProvider
    from newsclaw.llm.types import EndpointConfig, LLMRequest, Message
...
def test_qwen35_plus_supports_cache():
    ...
    from newsclaw.llm.model_registry import get_model_capabilities
...
def test_profile_unknown_key_falls_back_to_memory():
    ...
    都视为回归。
    """
    from newsclaw.core.feature_flags import clear_overrides, set_flag
    from newsclaw.tools.handlers.profile import ProfileHandler
