...
class TestUserManager:
    ...
    def test_user_creation(self, temp_storage):
        """测试用户创建"""
        from newsclaw.sessions import UserManager
...
class TestTriggers:
    ...
    def test_once_trigger(self):
        """测试一次性触发器"""
        from newsclaw.scheduler import OnceTrigger
    ...
    def test_interval_trigger(self):
        """测试间隔触发器"""
        from newsclaw.scheduler import IntervalTrigger
    ...
    def test_cron_trigger(self):
        """测试 Cron 触发器"""
        from newsclaw.scheduler import CronTrigger
...
class TestScheduledTask:
    ...
    def test_task_creation(self):
        """测试任务创建"""
        from newsclaw.scheduler import ScheduledTask, TriggerType
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="NewsClaw 新功能测试")
    parser.add_argument(
