...
from newsclaw.prompt.builder import PromptProfile, _build_catalogs_section
from newsclaw.skills.catalog import (
...
async def test_prompt_assembler_passes_intent_tool_hints(monkeypatch):
    ...
    monkeypatch.setattr("newsclaw.prompt.builder.build_system_prompt", fake_build_system_prompt)
