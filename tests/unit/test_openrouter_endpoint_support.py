...
from newsclaw.llm.registries.openrouter import OpenRouterRegistry
from newsclaw.setup_center.bridge import _list_models_openai
from newsclaw.tools.handlers.config import ConfigHandler
...
async def test_openrouter_registry_falls_back_to_router_models(monkeypatch):
    ...
    monkeypatch.setattr(
        "newsclaw.llm.registries.openrouter.create_registry_client",
