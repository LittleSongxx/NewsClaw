...
from newsclaw.core.policy_v2.param_mutation_audit import (
...
class TestClassifierCacheInvalidation:
    ...
    def test_skill_register_with_approval_class_invalidates(self, monkeypatch):
        ...
        from newsclaw.core.policy_v2 import global_engine
        from newsclaw.skills.registry import SkillEntry, SkillRegistry
    ...
    def test_mcp_disconnect_triggers_classifier_invalidate(self, monkeypatch):
        from newsclaw.core.policy_v2 import global_engine
        from newsclaw.tools.mcp import MCPClient
