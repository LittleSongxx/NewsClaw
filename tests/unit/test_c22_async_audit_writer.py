...
from newsclaw.core.policy_v2 import audit_chain
from newsclaw.core.policy_v2 import audit_writer as aw_mod
...
class TestAuditLoggerIntegration:
    ...
    async def test_log_routes_through_async_writer_when_running(self, audit_path: Path) -> None:
        ...
        try:
            ...
            from newsclaw.core.policy_v2.audit_writer import get_async_audit_writer
...
class TestServerLifecycleWiring:
    ...
    def test_server_registers_writer_startup_hook(self) -> None:
        ...
        from newsclaw.api import server as srv_mod
