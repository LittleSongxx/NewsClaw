...
from newsclaw.core.policy_v2.prompt_hardening import (
...
def test_tool_summary_replay_path_wraps_content():
    ...
    glue.
    """
    from newsclaw.core import _agent_runtime as _agent_mod
    from newsclaw.core.policy_v2 import prompt_hardening
