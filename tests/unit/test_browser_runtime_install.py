...
from newsclaw.optional_assets import OptionalAssetMirror
from newsclaw.tools.browser import manager
...
async def test_download_managed_chromium_uses_bundled_driver_cli(
    ...
    monkeypatch.setattr(
        "newsclaw.optional_features.configure_playwright_driver",
