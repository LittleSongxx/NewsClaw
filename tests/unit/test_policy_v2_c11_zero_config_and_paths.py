...
NewsClaw 跑在 Win / macOS / Linux. PathSpec 与 ``_path_under`` 必须保证:
...
from newsclaw.core.policy_v2.context import PolicyContext
from newsclaw.core.policy_v2.engine import PolicyEngineV2
from newsclaw.core.policy_v2.enums import ConfirmationMode, DecisionAction, SessionRole
from newsclaw.core.policy_v2.models import ToolCallEvent
from newsclaw.core.policy_v2.safety_immune_defaults import (
...
class TestR518ZeroConfigFirstInstall:
    ...
    def test_zero_config_global_engine_singleton_loads(self, monkeypatch, tmp_path):
        ...
        try:
            ...
            monkeypatch.setattr(
                "newsclaw.core.policy_v2.global_engine.Path",
                Path,
            )
