...
from newsclaw.orgs.runtime import _args_preview_brief, _describe_recent_event
...
def test_agent_run_finished_reports_output_and_artifact() -> None:
    ev = {
        ...
        "output_len": 452,
        "artifact_path": r"D:\NewsClaw\data\orgs\org_x\artifacts\cmd_1_editor_planner.md",
    }
