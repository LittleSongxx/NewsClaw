...
from newsclaw.agent.permission import check_permission
from newsclaw.agent.tools import ToolExecutor
from newsclaw.core import _reasoning_runtime as reasoning_engine_module
...
def _patch_engine_to_raise(monkeypatch: pytest.MonkeyPatch, exc: Exception) -> None:
    ...
    monkeypatch.setattr(
        "newsclaw.core.policy_v2.adapter._get_engine",
        _boom,
    )
