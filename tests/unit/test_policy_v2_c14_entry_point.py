...
from newsclaw.core.policy_v2.entry_point import (
    IM_WEBHOOK_CHANNELS,
...
def test_stream_renderer_security_confirm_skips_on_no_tty(monkeypatch):
    ...
    from newsclaw.cli import stream_renderer as sr
    ...
    with patch(
        "newsclaw.core.security_confirmation.resolve_security_confirmation",
...
def test_mcp_server_imports_classifier():
    ...
    import newsclaw.mcp_server as mcp_mod
