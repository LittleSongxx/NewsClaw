...
from newsclaw.agent.ui_confirm_bus import UIConfirmBus, reset_ui_confirm_bus
...
from newsclaw.core.policy_v2.schema import ConfirmationConfig, PolicyConfigV2
...
class TestBatchEndpoint:
    ...
    def test_endpoint_resolves_riskgate_tool_call_through_unified_resolver(
        ...
        classification = {
            ...
            "riskgate_scope": {"query": "NEWSCLAW_RISKGATE_689_REPRO_TEST"},
        }
        pending = (
