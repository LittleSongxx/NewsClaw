...
from newsclaw.core._brain_runtime import (
    Brain,
    Response,
...
from newsclaw.runtime.llm import CompilerCircuitBreaker
...
def test_compiler_configuration_reason_distinguishes_missing_and_disabled(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "newsclaw.core._brain_runtime.get_default_config_path", lambda: config_path
    )
...
def test_stable_main_chat_core_has_bounded_tools_in_fixed_order():
    from newsclaw.tools.defer_config import STABLE_MAIN_CHAT_CORE_TOOLS
