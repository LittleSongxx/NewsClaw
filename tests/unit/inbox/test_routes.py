...
from newsclaw.api.routes import inbox as inbox_routes
from newsclaw.inbox.models import InboxMessage
from newsclaw.inbox.service import InboxService
from newsclaw.inbox.store import InboxStore


async def test_inbox_routes_list_detail_and_mark(monkeypatch, tmp_path) -> None:
    monkeypatch.setattr("newsclaw.config.settings.inbox_register_enabled", False)
