...
import newsclaw.agent.identity as identity_mod
from newsclaw.agent import Agent
from newsclaw.agent.identity import Identity, _file_hash, _save_hashes
