...
from newsclaw.api.routes import memory_repair as repair_module
from newsclaw.storage.degraded import registry as degraded_registry
...
class TestDesktopTokenGate:
    """When ``NEWSCLAW_DESKTOP_SESSION_TOKEN`` is set, the quarantine
...
class TestTokenStatsRegistersUnderTokenTrackingKey:
    ...
    def test_register_helper_uses_shared_key(self) -> None:
        from newsclaw.api.routes import token_stats as ts
