...
from newsclaw.api.routes import upload
from newsclaw.runtime.desktop.attachments import format_desktop_attachment_reference
...
def test_audio_upload_uses_relaxed_audio_limit(tmp_path, monkeypatch):
    monkeypatch.setenv("NEWSCLAW_MAX_UPLOAD_MB", "0.000001")
    monkeypatch.setenv("NEWSCLAW_MAX_AUDIO_UPLOAD_MB", "1")
