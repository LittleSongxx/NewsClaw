...
from newsclaw.llm.cache import (
    SYSTEM_PROMPT_CONTEXT_BOUNDARY,
    SYSTEM_PROMPT_CONTEXT_END,
    build_cached_system_blocks,
)
from newsclaw.llm.converters.messages import convert_messages_to_openai
from newsclaw.llm.providers.openai import OpenAIProvider
from newsclaw.llm.types import EndpointConfig, LLMRequest, Message, ToolResultBlock, ToolUseBlock
...
def build_prompt(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("newsclaw.experience.summarize_recent_failures", lambda: [])
    monkeypatch.setattr("newsclaw.experience.format_failure_hint_section", lambda _: "")
