...
from newsclaw.api.auth import WebAccessConfig, create_auth_middleware
...
def diagnostic_app(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(bug_report, "_resolve_newsclaw_home_dir", lambda: tmp_path / "home")
    ...
    monkeypatch.delenv("NEWSCLAW_WEB_PASSWORD", raising=False)
