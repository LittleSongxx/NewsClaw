from newsclaw.agents.profile import AgentProfile, ProfileStore
from newsclaw.api import agent_events
from newsclaw.api.routes.agents import _build_agent_manager_state
...
def test_agent_change_events_use_stable_websocket_names(monkeypatch):
    ...
    monkeypatch.setattr("newsclaw.api.routes.websocket.fire_event", fake_fire_event)
