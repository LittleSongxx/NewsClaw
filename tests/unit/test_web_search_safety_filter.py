...
from newsclaw.agent.reasoning import ReasoningEngine
from newsclaw.tools.handlers.web_search import WebSearchHandler
from newsclaw.tools.tool_hints import ToolConfigError
from newsclaw.tools.web_search import runtime as web_search_runtime
from newsclaw.tools.web_search.base import (
...
async def test_web_search_attempt_timeout_is_soft_guidance(monkeypatch):
    ...
    monkeypatch.setattr("newsclaw.tools.handlers.web_search.run_web_search", fake_run_web_search)
...
async def test_web_search_no_provider_available_raises_config_hint(monkeypatch):
    ...
    from newsclaw.tools.web_search.base import NoProviderAvailable
