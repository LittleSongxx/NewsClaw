...
description: Search for Skills on the NewsClaw Platform Skill Store
system: true
handler: skill_store
...
Search for Skills on the NewsClaw Platform Skill Store.

## When to Use

- User wants to find or browse Skills on the NewsClaw marketplace
...
- **official**: Maintained by the NewsClaw team
