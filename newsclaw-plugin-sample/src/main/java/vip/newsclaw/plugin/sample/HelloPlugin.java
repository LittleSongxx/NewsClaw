package vip.newsclaw.plugin.sample;
...
/**
 * Sample plugin demonstrating the NewsClaw Plugin SDK.
 * <p>
 * Registers a simple "hello_world" tool that agents can call.
 *
 * @author NewsClaw Team
 */
public class HelloPlugin implements NewsClawPlugin {
    ...
    public String hello_world(
        ...
        return "Hello, " + name + "! This message comes from the NewsClaw Hello World plugin.";
    }
}
