# NewsClaw Desktop - Build & Publish Scripts
...
1. Build Vue 3 frontend to `newsclaw-server/src/main/resources/static`
2. Package Spring Boot fat JAR via Maven
3. Copy JAR to `newsclaw-desktop/resources/app.jar`
...
resources/app.jar            resources/jre/{os}-{arch}/
    ...
    +--------- electron-builder ---+
                    ...
                    v
              release/
              ├── NewsClaw_1.0.0_arm64.dmg
              ├── NewsClaw_1.0.0_x64.dmg
              ├── NewsClaw_1.0.0_arm64.zip
              ├── NewsClaw_1.0.0_x64.zip
              ├── NewsClaw_1.0.0_arm64_Setup.exe
              ├── NewsClaw_1.0.0_x64_Setup.exe
              ├── latest-mac.yml
              └── latest.yml
                    |
                    v
